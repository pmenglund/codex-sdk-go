...
- Primary runtime(s): Go 1.26.8+ and the `codex` CLI process (spawned and managed by the SDK).
...
- Compatibility constraints: Support Go 1.26.8 or newer and maintain protocol compatibility with generated schema versions.
