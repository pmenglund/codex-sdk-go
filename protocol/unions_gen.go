...
// CapabilityRootLocationKind identifies a known CapabilityRootLocation variant.
type CapabilityRootLocationKind string

const (
	// CapabilityRootLocationKindEnvironment is a generated Codex app-server protocol constant.
	CapabilityRootLocationKindEnvironment CapabilityRootLocationKind = "environment"
)

// CapabilityRootLocation preserves the complete JSON payload for a discriminated union.
type CapabilityRootLocation struct {
	kind CapabilityRootLocationKind
	raw  json.RawMessage
}

// NewCapabilityRootLocation validates the discriminator and wraps a JSON-marshalable CapabilityRootLocation value.
func NewCapabilityRootLocation(value any) (CapabilityRootLocation, error) {
	data, err := json.Marshal(value)
	if err != nil {
		return CapabilityRootLocation{}, err
	}
	var result CapabilityRootLocation
	err = json.Unmarshal(data, &result)
	return result, err
}
...
func (value *CapabilityRootLocation) UnmarshalJSON(data []byte) error {
	kind, raw, err := decodeDiscriminatedUnion(data, "type")
	if err != nil {
		return fmt.Errorf("decode CapabilityRootLocation: %w", err)
	}
	switch CapabilityRootLocationKind(kind) {
	case CapabilityRootLocationKindEnvironment:
		if err := requireDiscriminatedUnionFields(raw, "CapabilityRootLocation", kind, "environmentId", "path", "type"); err != nil {
			return err
		}
	}
	value.kind = CapabilityRootLocationKind(kind)
	value.raw = raw
	return nil
}
...
// Kind returns the payload discriminator, including unknown future values.
func (value CapabilityRootLocation) Kind() CapabilityRootLocationKind { return value.kind }

// RawJSON returns a copy of the complete union payload.
func (value CapabilityRootLocation) RawJSON() json.RawMessage {
	return append(json.RawMessage(nil), value.raw...)
}

// IsKnown reports whether the discriminator was present in the generation schema.
func (value CapabilityRootLocation) IsKnown() bool {
	switch value.kind {
	case CapabilityRootLocationKindEnvironment:
		return true
	default:
...
// ClientNotificationKind identifies a known ClientNotification variant.
type ClientNotificationKind string

const (
	// ClientNotificationKindInitialized is a generated Codex app-server protocol constant.
	ClientNotificationKindInitialized ClientNotificationKind = "initialized"
)

// ClientNotification preserves the complete JSON payload for a discriminated union.
type ClientNotification struct {
	kind ClientNotificationKind
	raw  json.RawMessage
}

// NewClientNotification validates the discriminator and wraps a JSON-marshalable ClientNotification value.
func NewClientNotification(value any) (ClientNotification, error) {
	data, err := json.Marshal(value)
	if err != nil {
...
// UnmarshalJSON implements generated Codex app-server protocol behavior.
func (value *ClientNotification) UnmarshalJSON(data []byte) error {
	kind, raw, err := decodeDiscriminatedUnion(data, "method")
	if err != nil {
		return fmt.Errorf("decode ClientNotification: %w", err)
	}
	switch ClientNotificationKind(kind) {
	case ClientNotificationKindInitialized:
		if err := requireDiscriminatedUnionFields(raw, "ClientNotification", kind, "method"); err != nil {
			return err
		}
	}
	value.kind = ClientNotificationKind(kind)
	value.raw = raw
	return nil
}

// MarshalJSON implements generated Codex app-server protocol behavior.
func (value ClientNotification) MarshalJSON() ([]byte, error) {
	if len(value.raw) == 0 {
		return []byte("null"), nil
	}
	return append([]byte(nil), value.raw...), nil
...
// Kind returns the payload discriminator, including unknown future values.
func (value ClientNotification) Kind() ClientNotificationKind { return value.kind }

// RawJSON returns a copy of the complete union payload.
func (value ClientNotification) RawJSON() json.RawMessage {
	return append(json.RawMessage(nil), value.raw...)
}

// IsKnown reports whether the discriminator was present in the generation schema.
func (value ClientNotification) IsKnown() bool {
	switch value.kind {
	case ClientNotificationKindInitialized:
		return true
	default:
...
const (
	...
	// ClientRequestKindPluginReconcile is a generated Codex app-server protocol constant.
	ClientRequestKindPluginReconcile ClientRequestKind = "plugin/reconcile"
	...
	// ClientRequestKindThreadItemsList is a generated Codex app-server protocol constant.
	...
	// ClientRequestKindThreadRevert is a generated Codex app-server protocol constant.
	...
	// ClientRequestKindThreadTurnsList is a generated Codex app-server protocol constant.
...
func (value *ClientRequest) UnmarshalJSON(data []byte) error {
	...
	case ClientRequestKindPluginReconcile:
		if err := requireDiscriminatedUnionFields(raw, "ClientRequest", kind, "id", "method", "params"); err != nil {
			return err
		}
	...
	case ClientRequestKindThreadSectionCreate:
		if err := requireDiscriminatedUnionFields(raw, "ClientRequest", kind, "id", "method", "params"); err != nil {
			return err
		}
	case ClientRequestKindThreadSectionDelete:
		if err := requireDiscriminatedUnionFields(raw, "ClientRequest", kind, "id", "method", "params"); err != nil {
			return err
		}
	...
	case ClientRequestKindThreadSectionUpdate:
		if err := requireDiscriminatedUnionFields(raw, "ClientRequest", kind, "id", "method", "params"); err != nil {
			return err
		}
...
const (
	...
	// ConfigLayerSourceKindPackagedDefaults is a generated Codex app-server protocol constant.
...
const (
	...
	// ConfiguredHookHandlerKindMCPTool is a generated Codex app-server protocol constant.
...
func (value *ConfiguredHookHandler) UnmarshalJSON(data []byte) error {
	...
	case ConfiguredHookHandlerKindMCPTool:
		if err := requireDiscriminatedUnionFields(raw, "ConfiguredHookHandler", kind, "input", "server", "tool", "type"); err != nil {
			return err
		}
...
// DynamicToolNamespaceToolKind identifies a known DynamicToolNamespaceTool variant.
type DynamicToolNamespaceToolKind string

const (
	// DynamicToolNamespaceToolKindFunction is a generated Codex app-server protocol constant.
	DynamicToolNamespaceToolKindFunction DynamicToolNamespaceToolKind = "function"
)

// DynamicToolNamespaceTool preserves the complete JSON payload for a discriminated union.
type DynamicToolNamespaceTool struct {
	kind DynamicToolNamespaceToolKind
	raw  json.RawMessage
}

// NewDynamicToolNamespaceTool validates the discriminator and wraps a JSON-marshalable DynamicToolNamespaceTool value.
func NewDynamicToolNamespaceTool(value any) (DynamicToolNamespaceTool, error) {
	data, err := json.Marshal(value)
	if err != nil {
		return DynamicToolNamespaceTool{}, err
	}
	var result DynamicToolNamespaceTool
	err = json.Unmarshal(data, &result)
	return result, err
}
...
func (value *DynamicToolNamespaceTool) UnmarshalJSON(data []byte) error {
	kind, raw, err := decodeDiscriminatedUnion(data, "type")
	if err != nil {
		return fmt.Errorf("decode DynamicToolNamespaceTool: %w", err)
	}
	switch DynamicToolNamespaceToolKind(kind) {
	case DynamicToolNamespaceToolKindFunction:
		if err := requireDiscriminatedUnionFields(raw, "DynamicToolNamespaceTool", kind, "description", "inputSchema", "name", "type"); err != nil {
			return err
		}
	}
	value.kind = DynamicToolNamespaceToolKind(kind)
	value.raw = raw
	return nil
}
...
// Kind returns the payload discriminator, including unknown future values.
func (value DynamicToolNamespaceTool) Kind() DynamicToolNamespaceToolKind { return value.kind }

// RawJSON returns a copy of the complete union payload.
func (value DynamicToolNamespaceTool) RawJSON() json.RawMessage {
	return append(json.RawMessage(nil), value.raw...)
}

// IsKnown reports whether the discriminator was present in the generation schema.
func (value DynamicToolNamespaceTool) IsKnown() bool {
	switch value.kind {
	case DynamicToolNamespaceToolKindFunction:
		return true
	default:
...
const (
	...
	// GuardianApprovalReviewActionKindWriteStdin is a generated Codex app-server protocol constant.
	GuardianApprovalReviewActionKindWriteStdin GuardianApprovalReviewActionKind = "writeStdin"
)
...
func (value *GuardianApprovalReviewAction) UnmarshalJSON(data []byte) error {
	...
	case GuardianApprovalReviewActionKindWriteStdin:
		if err := requireDiscriminatedUnionFields(raw, "GuardianApprovalReviewAction", kind, "approvalId", "cwd", "processId", "stdin", "type"); err != nil {
			return err
		}
	}
...
// HookMetadataKind identifies a known HookMetadata variant.
type HookMetadataKind string

const (
	// HookMetadataKindAgent is a generated Codex app-server protocol constant.
	HookMetadataKindAgent HookMetadataKind = "agent"
	// HookMetadataKindCommand is a generated Codex app-server protocol constant.
	HookMetadataKindCommand HookMetadataKind = "command"
	// HookMetadataKindMCPTool is a generated Codex app-server protocol constant.
	HookMetadataKindMCPTool HookMetadataKind = "mcpTool"
	// HookMetadataKindPrompt is a generated Codex app-server protocol constant.
	HookMetadataKindPrompt HookMetadataKind = "prompt"
)

// HookMetadata preserves the complete JSON payload for a discriminated union.
type HookMetadata struct {
	kind HookMetadataKind
	raw  json.RawMessage
}

// NewHookMetadata validates the discriminator and wraps a JSON-marshalable HookMetadata value.
func NewHookMetadata(value any) (HookMetadata, error) {
	data, err := json.Marshal(value)
	if err != nil {
		return HookMetadata{}, err
	}
	var result HookMetadata
	err = json.Unmarshal(data, &result)
	return result, err
}
...
func (value *HookMetadata) UnmarshalJSON(data []byte) error {
	kind, raw, err := decodeDiscriminatedUnion(data, "handlerType")
	if err != nil {
		return fmt.Errorf("decode HookMetadata: %w", err)
	}
	switch HookMetadataKind(kind) {
	case HookMetadataKindAgent:
		if err := requireDiscriminatedUnionFields(raw, "HookMetadata", kind, "currentHash", "displayOrder", "enabled", "eventName", "handlerType", "isManaged", "key", "source", "sourcePath", "timeoutSec", "trustStatus"); err != nil {
			return err
		}
	case HookMetadataKindCommand:
		if err := requireDiscriminatedUnionFields(raw, "HookMetadata", kind, "command", "currentHash", "displayOrder", "enabled", "eventName", "handlerType", "isManaged", "key", "source", "sourcePath", "timeoutSec", "trustStatus"); err != nil {
			return err
		}
	case HookMetadataKindMCPTool:
		if err := requireDiscriminatedUnionFields(raw, "HookMetadata", kind, "currentHash", "displayOrder", "enabled", "eventName", "handlerType", "isManaged", "key", "server", "source", "sourcePath", "timeoutSec", "tool", "trustStatus"); err != nil {
			return err
		}
	case HookMetadataKindPrompt:
		if err := requireDiscriminatedUnionFields(raw, "HookMetadata", kind, "currentHash", "displayOrder", "enabled", "eventName", "handlerType", "isManaged", "key", "source", "sourcePath", "timeoutSec", "trustStatus"); err != nil {
			return err
		}
	}
	value.kind = HookMetadataKind(kind)
	value.raw = raw
	return nil
}
...
// Kind returns the payload discriminator, including unknown future values.
func (value HookMetadata) Kind() HookMetadataKind { return value.kind }

// RawJSON returns a copy of the complete union payload.
func (value HookMetadata) RawJSON() json.RawMessage {
	return append(json.RawMessage(nil), value.raw...)
}

// IsKnown reports whether the discriminator was present in the generation schema.
func (value HookMetadata) IsKnown() bool {
	switch value.kind {
	case HookMetadataKindAgent:
		return true
	case HookMetadataKindCommand:
...
// ImageGenerationFailureKind identifies a known ImageGenerationFailure variant.
type ImageGenerationFailureKind string

const (
	// ImageGenerationFailureKindUsageLimitExceeded is a generated Codex app-server protocol constant.
	ImageGenerationFailureKindUsageLimitExceeded ImageGenerationFailureKind = "usageLimitExceeded"
)

// ImageGenerationFailure preserves the complete JSON payload for a discriminated union.
type ImageGenerationFailure struct {
	kind ImageGenerationFailureKind
	raw  json.RawMessage
}

// NewImageGenerationFailure validates the discriminator and wraps a JSON-marshalable ImageGenerationFailure value.
func NewImageGenerationFailure(value any) (ImageGenerationFailure, error) {
	data, err := json.Marshal(value)
	if err != nil {
		return ImageGenerationFailure{}, err
	}
	var result ImageGenerationFailure
	err = json.Unmarshal(data, &result)
	return result, err
}
...
func (value *ImageGenerationFailure) UnmarshalJSON(data []byte) error {
	kind, raw, err := decodeDiscriminatedUnion(data, "type")
	if err != nil {
		return fmt.Errorf("decode ImageGenerationFailure: %w", err)
	}
	switch ImageGenerationFailureKind(kind) {
	case ImageGenerationFailureKindUsageLimitExceeded:
		if err := requireDiscriminatedUnionFields(raw, "ImageGenerationFailure", kind, "limitId", "type"); err != nil {
			return err
		}
	}
	value.kind = ImageGenerationFailureKind(kind)
	value.raw = raw
	return nil
}
...
// Kind returns the payload discriminator, including unknown future values.
func (value ImageGenerationFailure) Kind() ImageGenerationFailureKind { return value.kind }

// RawJSON returns a copy of the complete union payload.
func (value ImageGenerationFailure) RawJSON() json.RawMessage {
	return append(json.RawMessage(nil), value.raw...)
}

// IsKnown reports whether the discriminator was present in the generation schema.
func (value ImageGenerationFailure) IsKnown() bool {
	switch value.kind {
	case ImageGenerationFailureKindUsageLimitExceeded:
		return true
	default:
...
// LocalShellActionKind identifies a known LocalShellAction variant.
type LocalShellActionKind string

const (
	// LocalShellActionKindExec is a generated Codex app-server protocol constant.
	LocalShellActionKindExec LocalShellActionKind = "exec"
)

// LocalShellAction preserves the complete JSON payload for a discriminated union.
type LocalShellAction struct {
	kind LocalShellActionKind
	raw  json.RawMessage
}

// NewLocalShellAction validates the discriminator and wraps a JSON-marshalable LocalShellAction value.
func NewLocalShellAction(value any) (LocalShellAction, error) {
	data, err := json.Marshal(value)
	if err != nil {
		return LocalShellAction{}, err
	}
	var result LocalShellAction
	err = json.Unmarshal(data, &result)
	return result, err
}

// UnmarshalJSON implements generated Codex app-server protocol behavior.
func (value *LocalShellAction) UnmarshalJSON(data []byte) error {
	kind, raw, err := decodeDiscriminatedUnion(data, "type")
	if err != nil {
		return fmt.Errorf("decode LocalShellAction: %w", err)
	}
	switch LocalShellActionKind(kind) {
	case LocalShellActionKindExec:
		if err := requireDiscriminatedUnionFields(raw, "LocalShellAction", kind, "command", "type"); err != nil {
			return err
		}
	}
	value.kind = LocalShellActionKind(kind)
	value.raw = raw
	return nil
}

// MarshalJSON implements generated Codex app-server protocol behavior.
func (value LocalShellAction) MarshalJSON() ([]byte, error) {
	if len(value.raw) == 0 {
		return []byte("null"), nil
	}
	return append([]byte(nil), value.raw...), nil
...
// Kind returns the payload discriminator, including unknown future values.
func (value LocalShellAction) Kind() LocalShellActionKind { return value.kind }

// RawJSON returns a copy of the complete union payload.
func (value LocalShellAction) RawJSON() json.RawMessage {
	return append(json.RawMessage(nil), value.raw...)
}

// IsKnown reports whether the discriminator was present in the generation schema.
func (value LocalShellAction) IsKnown() bool {
	switch value.kind {
	case LocalShellActionKindExec:
		return true
	default:
...
const (
	...
	// LoginAccountParamsKindAmazonBedrockAccessKeys is a generated Codex app-server protocol constant.
	LoginAccountParamsKindAmazonBedrockAccessKeys LoginAccountParamsKind = "amazonBedrockAccessKeys"
...
func (value *LoginAccountParams) UnmarshalJSON(data []byte) error {
	...
	case LoginAccountParamsKindAmazonBedrockAccessKeys:
		if err := requireDiscriminatedUnionFields(raw, "LoginAccountParams", kind, "accessKeyId", "region", "secretAccessKey", "type"); err != nil {
			return err
		}
...
// ReasoningItemReasoningSummaryKind identifies a known ReasoningItemReasoningSummary variant.
type ReasoningItemReasoningSummaryKind string

const (
	// ReasoningItemReasoningSummaryKindSummaryText is a generated Codex app-server protocol constant.
	ReasoningItemReasoningSummaryKindSummaryText ReasoningItemReasoningSummaryKind = "summary_text"
)

// ReasoningItemReasoningSummary preserves the complete JSON payload for a discriminated union.
type ReasoningItemReasoningSummary struct {
	kind ReasoningItemReasoningSummaryKind
	raw  json.RawMessage
}

// NewReasoningItemReasoningSummary validates the discriminator and wraps a JSON-marshalable ReasoningItemReasoningSummary value.
func NewReasoningItemReasoningSummary(value any) (ReasoningItemReasoningSummary, error) {
	data, err := json.Marshal(value)
	if err != nil {
		return ReasoningItemReasoningSummary{}, err
	}
	var result ReasoningItemReasoningSummary
	err = json.Unmarshal(data, &result)
	return result, err
}

// UnmarshalJSON implements generated Codex app-server protocol behavior.
func (value *ReasoningItemReasoningSummary) UnmarshalJSON(data []byte) error {
	kind, raw, err := decodeDiscriminatedUnion(data, "type")
	if err != nil {
		return fmt.Errorf("decode ReasoningItemReasoningSummary: %w", err)
	}
	switch ReasoningItemReasoningSummaryKind(kind) {
	case ReasoningItemReasoningSummaryKindSummaryText:
		if err := requireDiscriminatedUnionFields(raw, "ReasoningItemReasoningSummary", kind, "text", "type"); err != nil {
			return err
		}
	}
	value.kind = ReasoningItemReasoningSummaryKind(kind)
	value.raw = raw
	return nil
}

// MarshalJSON implements generated Codex app-server protocol behavior.
func (value ReasoningItemReasoningSummary) MarshalJSON() ([]byte, error) {
	if len(value.raw) == 0 {
		return []byte("null"), nil
	}
	return append([]byte(nil), value.raw...), nil
...
// Kind returns the payload discriminator, including unknown future values.
func (value ReasoningItemReasoningSummary) Kind() ReasoningItemReasoningSummaryKind {
	return value.kind
}

// RawJSON returns a copy of the complete union payload.
func (value ReasoningItemReasoningSummary) RawJSON() json.RawMessage {
	return append(json.RawMessage(nil), value.raw...)
}

// IsKnown reports whether the discriminator was present in the generation schema.
func (value ReasoningItemReasoningSummary) IsKnown() bool {
	switch value.kind {
	case ReasoningItemReasoningSummaryKindSummaryText:
		return true
	default:
...
const (
	...
	// ResponseItemKindConfigurationUpdate is a generated Codex app-server protocol constant.
...
func (value *ResponseItem) UnmarshalJSON(data []byte) error {
	...
	case ResponseItemKindConfigurationUpdate:
		if err := requireDiscriminatedUnionFields(raw, "ResponseItem", kind, "reasoning", "type"); err != nil {
			return err
		}
	...
	case ResponseItemKindFunctionCallOutput:
		if err := requireDiscriminatedUnionFields(raw, "ResponseItem", kind, "output", "type"); err != nil {
			return err
		}
...
const (
	...
	// ServerNotificationKindAutoApprovalReviewStrictReviewRequired is a generated Codex app-server protocol constant.
	ServerNotificationKindAutoApprovalReviewStrictReviewRequired ServerNotificationKind = "autoApprovalReview/strictReviewRequired"
	...
	// ServerNotificationKindMCPServerEventStreamNotification is a generated Codex app-server protocol constant.
	...
	// ServerNotificationKindModelProviderAuthRecoveryCompleted is a generated Codex app-server protocol constant.
	ServerNotificationKindModelProviderAuthRecoveryCompleted ServerNotificationKind = "modelProvider/authRecoveryCompleted"
	// ServerNotificationKindModelProviderAuthRecoveryStarted is a generated Codex app-server protocol constant.
	...
	// ServerNotificationKindProjectChanged is a generated Codex app-server protocol constant.
	ServerNotificationKindProjectChanged ServerNotificationKind = "project/changed"
	...
	// ServerNotificationKindThreadProjectUpdated is a generated Codex app-server protocol constant.
	ServerNotificationKindThreadProjectUpdated ServerNotificationKind = "thread/project/updated"
	// ServerNotificationKindThreadQueueChanged is a generated Codex app-server protocol constant.
	...
	// ServerNotificationKindThreadRealtimeItemCompleted is a generated Codex app-server protocol constant.
	ServerNotificationKindThreadRealtimeItemCompleted ServerNotificationKind = "thread/realtime/item/completed"
	// ServerNotificationKindThreadRealtimeItemStarted is a generated Codex app-server protocol constant.
	ServerNotificationKindThreadRealtimeItemStarted ServerNotificationKind = "thread/realtime/item/started"
	// ServerNotificationKindThreadRealtimeItemTranscriptDelta is a generated Codex app-server protocol constant.
	ServerNotificationKindThreadRealtimeItemTranscriptDelta ServerNotificationKind = "thread/realtime/item/transcript/delta"
	...
	// ServerNotificationKindThreadReverted is a generated Codex app-server protocol constant.
...
func (value *ServerNotification) UnmarshalJSON(data []byte) error {
	...
	case ServerNotificationKindAutoApprovalReviewStrictReviewRequired:
		if err := requireDiscriminatedUnionFields(raw, "ServerNotification", kind, "method", "params"); err != nil {
			return err
		}
	...
	case ServerNotificationKindMCPServerEventStreamNotification:
		if err := requireDiscriminatedUnionFields(raw, "ServerNotification", kind, "method", "params"); err != nil {
			return err
		}
	...
	case ServerNotificationKindProjectChanged:
		if err := requireDiscriminatedUnionFields(raw, "ServerNotification", kind, "method", "params"); err != nil {
			return err
		}
	...
	case ServerNotificationKindThreadProjectUpdated:
		if err := requireDiscriminatedUnionFields(raw, "ServerNotification", kind, "method", "params"); err != nil {
			return err
		}
	...
	case ServerNotificationKindThreadRealtimeItemCompleted:
		if err := requireDiscriminatedUnionFields(raw, "ServerNotification", kind, "method", "params"); err != nil {
			return err
		}
	case ServerNotificationKindThreadRealtimeItemStarted:
		if err := requireDiscriminatedUnionFields(raw, "ServerNotification", kind, "method", "params"); err != nil {
			return err
		}
	case ServerNotificationKindThreadRealtimeItemTranscriptDelta:
		if err := requireDiscriminatedUnionFields(raw, "ServerNotification", kind, "method", "params"); err != nil {
			return err
		}
...
const (
	...
	// ThreadItemKindFunctionCallOutput is a generated Codex app-server protocol constant.
...
func (value *ThreadItem) UnmarshalJSON(data []byte) error {
	...
	case ThreadItemKindFunctionCallOutput:
		if err := requireDiscriminatedUnionFields(raw, "ThreadItem", kind, "id", "name", "output", "type"); err != nil {
			return err
		}
...
// ThreadRealtimeBemItemPresentationKind identifies a known ThreadRealtimeBemItemPresentation variant.
type ThreadRealtimeBemItemPresentationKind string

const (
	// ThreadRealtimeBemItemPresentationKindInlineMarkdown is a generated Codex app-server protocol constant.
	ThreadRealtimeBemItemPresentationKindInlineMarkdown ThreadRealtimeBemItemPresentationKind = "inlineMarkdown"
	// ThreadRealtimeBemItemPresentationKindInlineVisualization is a generated Codex app-server protocol constant.
	ThreadRealtimeBemItemPresentationKindInlineVisualization ThreadRealtimeBemItemPresentationKind = "inlineVisualization"
	// ThreadRealtimeBemItemPresentationKindWholeItem is a generated Codex app-server protocol constant.
	ThreadRealtimeBemItemPresentationKindWholeItem ThreadRealtimeBemItemPresentationKind = "wholeItem"
)

// ThreadRealtimeBemItemPresentation preserves the complete JSON payload for a discriminated union.
type ThreadRealtimeBemItemPresentation struct {
	kind ThreadRealtimeBemItemPresentationKind
	raw  json.RawMessage
}

// NewThreadRealtimeBemItemPresentation validates the discriminator and wraps a JSON-marshalable ThreadRealtimeBemItemPresentation value.
func NewThreadRealtimeBemItemPresentation(value any) (ThreadRealtimeBemItemPresentation, error) {
	data, err := json.Marshal(value)
	if err != nil {
		return ThreadRealtimeBemItemPresentation{}, err
	}
	var result ThreadRealtimeBemItemPresentation
	err = json.Unmarshal(data, &result)
	return result, err
}
...
func (value *ThreadRealtimeBemItemPresentation) UnmarshalJSON(data []byte) error {
	kind, raw, err := decodeDiscriminatedUnion(data, "type")
	if err != nil {
		return fmt.Errorf("decode ThreadRealtimeBemItemPresentation: %w", err)
	}
	switch ThreadRealtimeBemItemPresentationKind(kind) {
	case ThreadRealtimeBemItemPresentationKindInlineMarkdown:
		if err := requireDiscriminatedUnionFields(raw, "ThreadRealtimeBemItemPresentation", kind, "type"); err != nil {
			return err
		}
	case ThreadRealtimeBemItemPresentationKindInlineVisualization:
		if err := requireDiscriminatedUnionFields(raw, "ThreadRealtimeBemItemPresentation", kind, "index", "type"); err != nil {
			return err
		}
	...
	value.kind = ThreadRealtimeBemItemPresentationKind(kind)
	value.raw = raw
	return nil
}
...
// RawJSON returns a copy of the complete union payload.
func (value ThreadRealtimeBemItemPresentation) RawJSON() json.RawMessage {
	return append(json.RawMessage(nil), value.raw...)
}

// IsKnown reports whether the discriminator was present in the generation schema.
func (value ThreadRealtimeBemItemPresentation) IsKnown() bool {
	switch value.kind {
	case ThreadRealtimeBemItemPresentationKindInlineMarkdown:
		return true
	case ThreadRealtimeBemItemPresentationKindInlineVisualization:
...
// ThreadRealtimeItemKind identifies a known ThreadRealtimeItem variant.
type ThreadRealtimeItemKind string

const (
	// ThreadRealtimeItemKindBemItemPromoted is a generated Codex app-server protocol constant.
	ThreadRealtimeItemKindBemItemPromoted ThreadRealtimeItemKind = "bemItemPromoted"
	// ThreadRealtimeItemKindRealtimeSessionClosed is a generated Codex app-server protocol constant.
	ThreadRealtimeItemKindRealtimeSessionClosed ThreadRealtimeItemKind = "realtimeSessionClosed"
	// ThreadRealtimeItemKindRealtimeSessionStarted is a generated Codex app-server protocol constant.
	ThreadRealtimeItemKindRealtimeSessionStarted ThreadRealtimeItemKind = "realtimeSessionStarted"
	// ThreadRealtimeItemKindTranscriptSegment is a generated Codex app-server protocol constant.
	ThreadRealtimeItemKindTranscriptSegment ThreadRealtimeItemKind = "transcriptSegment"
)

// ThreadRealtimeItem preserves the complete JSON payload for a discriminated union.
type ThreadRealtimeItem struct {
	kind ThreadRealtimeItemKind
	raw  json.RawMessage
}

// NewThreadRealtimeItem validates the discriminator and wraps a JSON-marshalable ThreadRealtimeItem value.
func NewThreadRealtimeItem(value any) (ThreadRealtimeItem, error) {
	data, err := json.Marshal(value)
	if err != nil {
		return ThreadRealtimeItem{}, err
	}
	var result ThreadRealtimeItem
	err = json.Unmarshal(data, &result)
	return result, err
}
...
func (value *ThreadRealtimeItem) UnmarshalJSON(data []byte) error {
	kind, raw, err := decodeDiscriminatedUnion(data, "type")
	if err != nil {
		return fmt.Errorf("decode ThreadRealtimeItem: %w", err)
	}
	switch ThreadRealtimeItemKind(kind) {
	case ThreadRealtimeItemKindBemItemPromoted:
		if err := requireDiscriminatedUnionFields(raw, "ThreadRealtimeItem", kind, "id", "item_id", "presentation", "realtimeSessionId", "turn_id", "type"); err != nil {
			return err
		}
	case ThreadRealtimeItemKindRealtimeSessionClosed:
		if err := requireDiscriminatedUnionFields(raw, "ThreadRealtimeItem", kind, "id", "outcome", "realtimeSessionId", "type"); err != nil {
			return err
		}
	case ThreadRealtimeItemKindRealtimeSessionStarted:
		if err := requireDiscriminatedUnionFields(raw, "ThreadRealtimeItem", kind, "id", "realtimeSessionId", "type"); err != nil {
			return err
		}
	case ThreadRealtimeItemKindTranscriptSegment:
		if err := requireDiscriminatedUnionFields(raw, "ThreadRealtimeItem", kind, "id", "realtimeSessionId", "role", "text", "type"); err != nil {
			return err
		}
	}
	value.kind = ThreadRealtimeItemKind(kind)
	value.raw = raw
	return nil
}
...
// Kind returns the payload discriminator, including unknown future values.
func (value ThreadRealtimeItem) Kind() ThreadRealtimeItemKind { return value.kind }

// RawJSON returns a copy of the complete union payload.
func (value ThreadRealtimeItem) RawJSON() json.RawMessage {
	return append(json.RawMessage(nil), value.raw...)
}

// IsKnown reports whether the discriminator was present in the generation schema.
func (value ThreadRealtimeItem) IsKnown() bool {
	switch value.kind {
	case ThreadRealtimeItemKindBemItemPromoted:
		return true
	case ThreadRealtimeItemKindRealtimeSessionClosed:
...
const (
	// ThreadRealtimeStartTransportKindExistingCall is a generated Codex app-server protocol constant.
	ThreadRealtimeStartTransportKindExistingCall ThreadRealtimeStartTransportKind = "existingCall"
...
func (value *ThreadRealtimeStartTransport) UnmarshalJSON(data []byte) error {
	...
	case ThreadRealtimeStartTransportKindExistingCall:
		if err := requireDiscriminatedUnionFields(raw, "ThreadRealtimeStartTransport", kind, "callId", "type"); err != nil {
			return err
		}
...
// ThreadTimelineEntryKind identifies a known ThreadTimelineEntry variant.
type ThreadTimelineEntryKind string

const (
	// ThreadTimelineEntryKindItem is a generated Codex app-server protocol constant.
	ThreadTimelineEntryKindItem ThreadTimelineEntryKind = "item"
	// ThreadTimelineEntryKindRealtime is a generated Codex app-server protocol constant.
	ThreadTimelineEntryKindRealtime ThreadTimelineEntryKind = "realtime"
	// ThreadTimelineEntryKindTurnCompleted is a generated Codex app-server protocol constant.
	ThreadTimelineEntryKindTurnCompleted ThreadTimelineEntryKind = "turnCompleted"
	// ThreadTimelineEntryKindTurnStarted is a generated Codex app-server protocol constant.
	ThreadTimelineEntryKindTurnStarted ThreadTimelineEntryKind = "turnStarted"
)

// ThreadTimelineEntry preserves the complete JSON payload for a discriminated union.
type ThreadTimelineEntry struct {
	kind ThreadTimelineEntryKind
	raw  json.RawMessage
}

// NewThreadTimelineEntry validates the discriminator and wraps a JSON-marshalable ThreadTimelineEntry value.
func NewThreadTimelineEntry(value any) (ThreadTimelineEntry, error) {
	data, err := json.Marshal(value)
	if err != nil {
		return ThreadTimelineEntry{}, err
	}
...
func (value *ThreadTimelineEntry) UnmarshalJSON(data []byte) error {
	kind, raw, err := decodeDiscriminatedUnion(data, "type")
	if err != nil {
		return fmt.Errorf("decode ThreadTimelineEntry: %w", err)
	}
	switch ThreadTimelineEntryKind(kind) {
	case ThreadTimelineEntryKindItem:
		if err := requireDiscriminatedUnionFields(raw, "ThreadTimelineEntry", kind, "item", "position", "turnId", "type"); err != nil {
			return err
		}
	case ThreadTimelineEntryKindRealtime:
		if err := requireDiscriminatedUnionFields(raw, "ThreadTimelineEntry", kind, "item", "position", "type"); err != nil {
			return err
		}
	case ThreadTimelineEntryKindTurnCompleted:
		if err := requireDiscriminatedUnionFields(raw, "ThreadTimelineEntry", kind, "position", "status", "turn_id", "type"); err != nil {
			return err
		}
	case ThreadTimelineEntryKindTurnStarted:
		if err := requireDiscriminatedUnionFields(raw, "ThreadTimelineEntry", kind, "position", "turn_id", "type"); err != nil {
			return err
		}
	}
	value.kind = ThreadTimelineEntryKind(kind)
	value.raw = raw
	return nil
}
...
// Kind returns the payload discriminator, including unknown future values.
func (value ThreadTimelineEntry) Kind() ThreadTimelineEntryKind { return value.kind }

// RawJSON returns a copy of the complete union payload.
func (value ThreadTimelineEntry) RawJSON() json.RawMessage {
	return append(json.RawMessage(nil), value.raw...)
}

// IsKnown reports whether the discriminator was present in the generation schema.
func (value ThreadTimelineEntry) IsKnown() bool {
	switch value.kind {
	case ThreadTimelineEntryKindItem:
		return true
	case ThreadTimelineEntryKindRealtime:
