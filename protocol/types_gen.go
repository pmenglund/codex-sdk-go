...
type CommandExecParams struct {
	...
	// to the user's configured policy when omitted.
...
type GuardianApprovalReview struct {
	...
	RiskLevel interface{} `json:"riskLevel,omitempty"`

	// Status corresponds to the JSON schema field "status".
	Status GuardianApprovalReviewStatus `json:"status"`

	// UserAuthorization corresponds to the JSON schema field "userAuthorization".
	UserAuthorization interface{} `json:"userAuthorization,omitempty"`
}
...
const GuardianApprovalReviewStatusAborted GuardianApprovalReviewStatus = "aborted"
const GuardianApprovalReviewStatusApproved GuardianApprovalReviewStatus = "approved"
const GuardianApprovalReviewStatusDenied GuardianApprovalReviewStatus = "denied"
const GuardianApprovalReviewStatusInProgress GuardianApprovalReviewStatus = "inProgress"

type GuardianCommandSource string

const GuardianCommandSourceShell GuardianCommandSource = "shell"
const GuardianCommandSourceUnifiedExec GuardianCommandSource = "unifiedExec"

type GuardianRiskLevel string

const GuardianRiskLevelCritical GuardianRiskLevel = "critical"
const GuardianRiskLevelHigh GuardianRiskLevel = "high"
const GuardianRiskLevelLow GuardianRiskLevel = "low"
const GuardianRiskLevelMedium GuardianRiskLevel = "medium"

type GuardianUserAuthorization string

const GuardianUserAuthorizationHigh GuardianUserAuthorization = "high"
const GuardianUserAuthorizationLow GuardianUserAuthorization = "low"
const GuardianUserAuthorizationMedium GuardianUserAuthorization = "medium"
const GuardianUserAuthorizationUnknown GuardianUserAuthorization = "unknown"

type HookEventName string

const HookEventNamePostToolUse HookEventName = "postToolUse"
const HookEventNamePreToolUse HookEventName = "preToolUse"
const HookEventNameSessionStart HookEventName = "sessionStart"
const HookEventNameStop HookEventName = "stop"
const HookEventNameUserPromptSubmit HookEventName = "userPromptSubmit"

type HookExecutionMode string

const HookExecutionModeAsync HookExecutionMode = "async"
const HookExecutionModeSync HookExecutionMode = "sync"

type HookHandlerType string

const HookHandlerTypeAgent HookHandlerType = "agent"
const HookHandlerTypeCommand HookHandlerType = "command"
const HookHandlerTypePrompt HookHandlerType = "prompt"
...
const HookOutputEntryKindContext HookOutputEntryKind = "context"
const HookOutputEntryKindError HookOutputEntryKind = "error"
const HookOutputEntryKindFeedback HookOutputEntryKind = "feedback"
const HookOutputEntryKindStop HookOutputEntryKind = "stop"
const HookOutputEntryKindWarning HookOutputEntryKind = "warning"

type HookRunStatus string

const HookRunStatusBlocked HookRunStatus = "blocked"
const HookRunStatusCompleted HookRunStatus = "completed"
const HookRunStatusFailed HookRunStatus = "failed"
const HookRunStatusRunning HookRunStatus = "running"
const HookRunStatusStopped HookRunStatus = "stopped"
...
type HookRunSummary struct {
	...
	// DisplayOrder corresponds to the JSON schema field "displayOrder".
	...
	// EventName corresponds to the JSON schema field "eventName".
	EventName HookEventName `json:"eventName"`

	// ExecutionMode corresponds to the JSON schema field "executionMode".
	ExecutionMode HookExecutionMode `json:"executionMode"`

	// HandlerType corresponds to the JSON schema field "handlerType".
	...
	// SourcePath corresponds to the JSON schema field "sourcePath".
	...
	// StatusMessage corresponds to the JSON schema field "statusMessage".
	StatusMessage *string `json:"statusMessage,omitempty"`
}

type HookScope string

const HookScopeThread HookScope = "thread"
const HookScopeTurn HookScope = "turn"
...
type NetworkRequirements struct {
	...
	// DangerFullAccessDenylistOnly corresponds to the JSON schema field
	// "dangerFullAccessDenylistOnly".
	DangerFullAccessDenylistOnly *bool `json:"dangerFullAccessDenylistOnly,omitempty"`
...
type PluginListParams struct {
	...
	// When true, reconcile the official curated marketplace against the remote plugin
	// state before listing marketplaces.
	ForceRemoteSync *bool `json:"forceRemoteSync,omitempty"`
}
...
type SanitizedHookCompletedNotificationJSON struct {
...
type SanitizedHookStartedNotificationJSON struct {
	// Run corresponds to the JSON schema field "run".
	Run HookRunSummary `json:"run"`
...
type SanitizedItemGuardianApprovalReviewCompletedNotificationJSON struct {
	// Action corresponds to the JSON schema field "action".
	Action SanitizedItemGuardianApprovalReviewCompletedNotificationJSONAction `json:"action"`

	// DecisionSource corresponds to the JSON schema field "decisionSource".
	...
	// reviews, where a single command may contain multiple execve calls to review
	// (only possible when using the shell_zsh_fork feature) - network policy reviews,
	// where there is no target item
	//
	// A network call is triggered by a CommandExecution item, so having a
	// target_item_id set to the CommandExecution item would be misleading because the
	// review is about the network call, not the command execution. Therefore,
	// target_item_id is set to None for network policy reviews.
...
type SanitizedItemGuardianApprovalReviewCompletedNotificationJSONAction interface{}

// [UNSTABLE] Temporary notification payload for guardian automatic approval
// review. This shape is expected to change soon.
type SanitizedItemGuardianApprovalReviewStartedNotificationJSON struct {
	// Action corresponds to the JSON schema field "action".
	Action SanitizedItemGuardianApprovalReviewStartedNotificationJSONAction `json:"action"`
...
type SanitizedItemGuardianApprovalReviewStartedNotificationJSONAction interface{}
...
// changes.
type SanitizedThreadRealtimeTranscriptUpdatedNotificationJSON struct {
