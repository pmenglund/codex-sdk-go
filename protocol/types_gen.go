...
// AllowDenyRequirement represents a generated Codex app-server protocol type.
type AllowDenyRequirement string

// AllowDenyRequirementAllow is a generated Codex app-server protocol constant.
const AllowDenyRequirementAllow AllowDenyRequirement = "allow"

// AllowDenyRequirementDeny is a generated Codex app-server protocol constant.
const AllowDenyRequirementDeny AllowDenyRequirement = "deny"
...
// AppToolSummary represents a generated Codex app-server protocol type.
...
// ApplicationNetworkRequirements represents a generated Codex app-server protocol type.
type ApplicationNetworkRequirements struct {
	// Domains corresponds to the JSON schema field "domains".
	Domains ApplicationNetworkRequirementsDomains `json:"domains"`

	// When enabled, only explicitly allowed exact domains may be contacted.
	Enabled bool `json:"enabled"`
}

// ApplicationNetworkRequirementsDomains represents a generated Codex app-server protocol type.
type ApplicationNetworkRequirementsDomains map[string]NetworkDomainPermission

// ApplicationRequirements represents a generated Codex app-server protocol type.
type ApplicationRequirements struct {
	// Network corresponds to the JSON schema field "network".
	Network *ApplicationNetworkRequirements `json:"network,omitempty,omitzero"`
}

// ApplyPatchApprovalParamsFileChanges represents a generated Codex app-server protocol type.
type ApplyPatchApprovalParamsFileChanges map[string]FileChange

// ApplyPatchApprovalParamsGrantRoot represents a generated Codex app-server protocol type.
...
// ApplyPatchApprovalParamsReason represents a generated Codex app-server protocol type.
...
// AppsInstalledParams represents a generated Codex app-server protocol type.
...
// AppsInstalledParamsThreadID represents a generated Codex app-server protocol type.
// Optional loaded thread id used to evaluate effective app configuration.
...
// AppsReadParams represents a generated Codex app-server protocol type.
...
type AppsReadParams struct {
	...
	// Optional loaded thread id used to evaluate effective app configuration.
	ThreadID AppsReadParamsThreadID `json:"threadId,omitempty,omitzero"`
}

// AppsReadParamsThreadID represents a generated Codex app-server protocol type.
// Optional loaded thread id used to evaluate effective app configuration.
type AppsReadParamsThreadID *string
...
// AutoReviewRequirements represents a generated Codex app-server protocol type.
type AutoReviewRequirements struct {
	// IgnoreRules corresponds to the JSON schema field "ignoreRules".
	IgnoreRules *AutoReviewRequirementsIgnoreRules `json:"ignoreRules,omitempty,omitzero"`

	// RequiredOnModels corresponds to the JSON schema field "requiredOnModels".
	RequiredOnModels *AutoReviewRequirementsRequiredOnModels `json:"requiredOnModels,omitempty,omitzero"`
}

// AutoReviewRequirementsIgnoreRules represents a generated Codex app-server protocol type.
type AutoReviewRequirementsIgnoreRules []string

// AutoReviewRequirementsRequiredOnModels represents a generated Codex app-server protocol type.
type AutoReviewRequirementsRequiredOnModels []string

// BrowserUseAccessApprovalLifetime represents a generated Codex app-server protocol type.
type BrowserUseAccessApprovalLifetime string

// BrowserUseAccessApprovalLifetimeThread is a generated Codex app-server protocol constant.
const BrowserUseAccessApprovalLifetimeThread BrowserUseAccessApprovalLifetime = "thread"

// BrowserUseAccessApprovalLifetimeTurn is a generated Codex app-server protocol constant.
const BrowserUseAccessApprovalLifetimeTurn BrowserUseAccessApprovalLifetime = "turn"

// BrowserUseOriginPolicy represents a generated Codex app-server protocol type.
type BrowserUseOriginPolicy struct {
	// Access corresponds to the JSON schema field "access".
	Access *AllowDenyRequirement `json:"access,omitempty,omitzero"`

	// AccessApprovalLifetime corresponds to the JSON schema field
	// "accessApprovalLifetime".
	AccessApprovalLifetime *BrowserUseAccessApprovalLifetime `json:"accessApprovalLifetime,omitempty,omitzero"`

	// AutoReview corresponds to the JSON schema field "autoReview".
	AutoReview *AllowDenyRequirement `json:"autoReview,omitempty,omitzero"`

	// Downloads corresponds to the JSON schema field "downloads".
	Downloads *AllowDenyRequirement `json:"downloads,omitempty,omitzero"`

	// FullCdpAccess corresponds to the JSON schema field "fullCdpAccess".
	FullCdpAccess *AllowDenyRequirement `json:"fullCdpAccess,omitempty,omitzero"`

	// PersistentApproval corresponds to the JSON schema field "persistentApproval".
	PersistentApproval BrowserUseOriginPolicyPersistentApproval `json:"persistentApproval,omitempty,omitzero"`

	// Uploads corresponds to the JSON schema field "uploads".
	Uploads *AllowDenyRequirement `json:"uploads,omitempty,omitzero"`
}

// BrowserUseOriginPolicyPersistentApproval represents a generated Codex app-server protocol type.
type BrowserUseOriginPolicyPersistentApproval *bool

// BrowserUseRequirements represents a generated Codex app-server protocol type.
type BrowserUseRequirements struct {
	// AllowGlobalPersistentApproval corresponds to the JSON schema field
	// "allowGlobalPersistentApproval".
	AllowGlobalPersistentApproval BrowserUseRequirementsAllowGlobalPersistentApproval `json:"allowGlobalPersistentApproval,omitempty,omitzero"`

	// AllowHistoryAccess corresponds to the JSON schema field "allowHistoryAccess".
	AllowHistoryAccess BrowserUseRequirementsAllowHistoryAccess `json:"allowHistoryAccess,omitempty,omitzero"`

	// AllowWebmcp corresponds to the JSON schema field "allowWebmcp".
	AllowWebmcp BrowserUseRequirementsAllowWebmcp `json:"allowWebmcp,omitempty,omitzero"`

	// DefaultOriginPolicy corresponds to the JSON schema field "defaultOriginPolicy".
	DefaultOriginPolicy *BrowserUseOriginPolicy `json:"defaultOriginPolicy,omitempty,omitzero"`
	...
	Origins *BrowserUseRequirementsOrigins `json:"origins,omitempty,omitzero"`
}

// BrowserUseRequirementsAllowGlobalPersistentApproval represents a generated Codex app-server protocol type.
type BrowserUseRequirementsAllowGlobalPersistentApproval *bool

// BrowserUseRequirementsAllowHistoryAccess represents a generated Codex app-server protocol type.
type BrowserUseRequirementsAllowHistoryAccess *bool

// BrowserUseRequirementsAllowWebmcp represents a generated Codex app-server protocol type.
type BrowserUseRequirementsAllowWebmcp *bool
...
// BrowserUseRequirementsOrigins represents a generated Codex app-server protocol type.
type BrowserUseRequirementsOrigins map[string]BrowserUseOriginPolicy
...
// ChatgptAuthTokensRefreshParamsPreviousAccountID represents a generated Codex app-server protocol type.
...
// CliAuthCredentialsStoreMode represents a generated Codex app-server protocol type.
type CliAuthCredentialsStoreMode string

// CliAuthCredentialsStoreModeAuto is a generated Codex app-server protocol constant.
const CliAuthCredentialsStoreModeAuto CliAuthCredentialsStoreMode = "auto"

// CliAuthCredentialsStoreModeEphemeral is a generated Codex app-server protocol constant.
const CliAuthCredentialsStoreModeEphemeral CliAuthCredentialsStoreMode = "ephemeral"

// CliAuthCredentialsStoreModeFile is a generated Codex app-server protocol constant.
const CliAuthCredentialsStoreModeFile CliAuthCredentialsStoreMode = "file"

// CliAuthCredentialsStoreModeKeyring is a generated Codex app-server protocol constant.
const CliAuthCredentialsStoreModeKeyring CliAuthCredentialsStoreMode = "keyring"
...
// CommandExecutionApprovalKind represents a generated Codex app-server protocol type.
type CommandExecutionApprovalKind string

// CommandExecutionApprovalKindCommand is a generated Codex app-server protocol constant.
const CommandExecutionApprovalKindCommand CommandExecutionApprovalKind = "command"

// CommandExecutionApprovalKindWriteStdin is a generated Codex app-server protocol constant.
const CommandExecutionApprovalKindWriteStdin CommandExecutionApprovalKind = "writeStdin"
...
// ComputerUseMacosRequirements represents a generated Codex app-server protocol type.
type ComputerUseMacosRequirements struct {
	// BundleIds corresponds to the JSON schema field "bundleIds".
	BundleIds *ComputerUseMacosRequirementsBundleIds `json:"bundleIds,omitempty,omitzero"`
}

// ComputerUseMacosRequirementsBundleIds represents a generated Codex app-server protocol type.
type ComputerUseMacosRequirementsBundleIds map[string]AllowDenyRequirement
...
type ComputerUseRequirements struct {
	...
	// AllowPersistentApproval corresponds to the JSON schema field
	// "allowPersistentApproval".
	AllowPersistentApproval ComputerUseRequirementsAllowPersistentApproval `json:"allowPersistentApproval,omitempty,omitzero"`

	// DefaultAppAccess corresponds to the JSON schema field "defaultAppAccess".
	DefaultAppAccess *AllowDenyRequirement `json:"defaultAppAccess,omitempty,omitzero"`

	// Macos corresponds to the JSON schema field "macos".
	Macos *ComputerUseMacosRequirements `json:"macos,omitempty,omitzero"`

	// Windows corresponds to the JSON schema field "windows".
	Windows *ComputerUseWindowsRequirements `json:"windows,omitempty,omitzero"`
}
...
// ComputerUseRequirementsAllowPersistentApproval represents a generated Codex app-server protocol type.
type ComputerUseRequirementsAllowPersistentApproval *bool

// ComputerUseWindowsExeRequirement represents a generated Codex app-server protocol type.
type ComputerUseWindowsExeRequirement struct {
	// Access corresponds to the JSON schema field "access".
	Access AllowDenyRequirement `json:"access"`

	// BinaryName corresponds to the JSON schema field "binaryName".
	BinaryName ComputerUseWindowsExeRequirementBinaryName `json:"binaryName,omitempty,omitzero"`

	// ProductName corresponds to the JSON schema field "productName".
	ProductName string `json:"productName"`

	// PublisherName corresponds to the JSON schema field "publisherName".
	PublisherName string `json:"publisherName"`
}

// ComputerUseWindowsExeRequirementBinaryName represents a generated Codex app-server protocol type.
type ComputerUseWindowsExeRequirementBinaryName *string

// ComputerUseWindowsRequirements represents a generated Codex app-server protocol type.
type ComputerUseWindowsRequirements struct {
	// Aumids corresponds to the JSON schema field "aumids".
	Aumids *ComputerUseWindowsRequirementsAumids `json:"aumids,omitempty,omitzero"`

	// Exes corresponds to the JSON schema field "exes".
	Exes *ComputerUseWindowsRequirementsExes `json:"exes,omitempty,omitzero"`
}

// ComputerUseWindowsRequirementsAumids represents a generated Codex app-server protocol type.
type ComputerUseWindowsRequirementsAumids map[string]AllowDenyRequirement

// ComputerUseWindowsRequirementsExes represents a generated Codex app-server protocol type.
type ComputerUseWindowsRequirementsExes []ComputerUseWindowsExeRequirement
...
type ConfigRequirements struct {
	// AdditionalDeveloperInstructions corresponds to the JSON schema field
	// "additionalDeveloperInstructions".
	AdditionalDeveloperInstructions ConfigRequirementsAdditionalDeveloperInstructions `json:"additionalDeveloperInstructions,omitempty,omitzero"`
	...
	// AllowBrowserAndComputerUse corresponds to the JSON schema field
	// "allowBrowserAndComputerUse".
	AllowBrowserAndComputerUse ConfigRequirementsAllowBrowserAndComputerUse `json:"allowBrowserAndComputerUse,omitempty,omitzero"`
	...
	// AutoReview corresponds to the JSON schema field "autoReview".
	AutoReview *AutoReviewRequirements `json:"autoReview,omitempty,omitzero"`
	...
	// ChatgptBaseURL corresponds to the JSON schema field "chatgptBaseUrl".
	ChatgptBaseURL ConfigRequirementsChatgptBaseURL `json:"chatgptBaseUrl,omitempty,omitzero"`
	...
	// CliAuthCredentialsStore corresponds to the JSON schema field
	// "cliAuthCredentialsStore".
	CliAuthCredentialsStore *CliAuthCredentialsStoreMode `json:"cliAuthCredentialsStore,omitempty,omitzero"`
	...
	// InAppBrowser corresponds to the JSON schema field "inAppBrowser".
	InAppBrowser *InAppBrowserRequirements `json:"inAppBrowser,omitempty,omitzero"`
...
// ConfigRequirementsAdditionalDeveloperInstructions represents a generated Codex app-server protocol type.
type ConfigRequirementsAdditionalDeveloperInstructions *string
...
// ConfigRequirementsAllowBrowserAndComputerUse represents a generated Codex app-server protocol type.
type ConfigRequirementsAllowBrowserAndComputerUse *bool
...
// ConfigRequirementsChatgptBaseURL represents a generated Codex app-server protocol type.
type ConfigRequirementsChatgptBaseURL *string
...
// ConfigurationReasoning represents a generated Codex app-server protocol type.
...
// ConnectorMetadata represents a generated Codex app-server protocol type.
// EXPERIMENTAL - metadata returned by app/read.
...
// CyberAccessProgram represents a generated Codex app-server protocol type.
type CyberAccessProgram string

// CyberAccessProgramDaybreakBlue is a generated Codex app-server protocol constant.
const CyberAccessProgramDaybreakBlue CyberAccessProgram = "daybreakBlue"

// CyberAccessProgramDaybreakRed is a generated Codex app-server protocol constant.
const CyberAccessProgramDaybreakRed CyberAccessProgram = "daybreakRed"

// CyberAccessProgramStandard is a generated Codex app-server protocol constant.
const CyberAccessProgramStandard CyberAccessProgram = "standard"
...
// ExternalAgentConfigDetectParamsMaxSessionAgeDays represents a generated Codex app-server protocol type.
...
// ExternalAgentConfigDetectParamsMaxSessions represents a generated Codex app-server protocol type.
// Maximum number of sessions to detect. Missing values use the default limit.
type ExternalAgentConfigDetectParamsMaxSessions *int

// ExternalAgentConfigDetectParamsMigrationSource represents a generated Codex app-server protocol type.
// Optional migration-source selector. Missing or unrecognized values use the
// default source.
type ExternalAgentConfigDetectParamsMigrationSource *string

// ExternalAgentConfigDetectParamsSource represents a generated Codex app-server protocol type.
// Deprecated field retained for compatibility. This field is ignored; use
// `migrationSource` to select the migration source.
...
// ExternalAgentConfigImportHistoryRecordSuccessParamsTitle represents a generated Codex app-server protocol type.
// Original title for an imported session, when available.
...
// ExternalAgentConfigImportItemTypeSuccessTitle represents a generated Codex app-server protocol type.
// Original title for an imported session; null for other item types.
...
// ExternalAgentConfigImportParamsMigrationSource represents a generated Codex app-server protocol type.
// Migration-source selector used to produce the migration items. Pass the same
// value to detection and import; missing or unrecognized values use the default
// source.
type ExternalAgentConfigImportParamsMigrationSource *string

// ExternalAgentConfigImportParamsProviderID represents a generated Codex app-server protocol type.
// Opaque provider identifier supplied by the caller for analytics attribution and
// import history display. This does not select the migration source.
...
// GetAccountRateLimitsParams represents a generated Codex app-server protocol type.
// Usage-read capabilities of the requesting client, never inferred from its
// experiment arm.
type GetAccountRateLimitsParams struct {
	// Skip the separate reset-credit detail lookup for background usage polls. The
	// usage response still includes the available count; omitted/false preserves
	// detailed reads.
	ExcludeResetCreditDetails *bool `json:"excludeResetCreditDetails,omitempty,omitzero"`

	// The client supports automatic Luna Reserve fallback. For eligible ChatGPT CLI
	// users, allow the backend to record experiment exposure after ordinary usage is
	// blocked.
	SupportsLunaReserve *bool `json:"supportsLunaReserve,omitempty,omitzero"`
}

// GetAccountTokenUsageParams represents a generated Codex app-server protocol type.
type GetAccountTokenUsageParams struct {
	// When present, read estimated usage for this thread instead of account-wide
	// token activity.
	ThreadID GetAccountTokenUsageParamsThreadID `json:"threadId,omitempty,omitzero"`
}

// GetAccountTokenUsageParamsThreadID represents a generated Codex app-server protocol type.
// When present, read estimated usage for this thread instead of account-wide token
// activity.
type GetAccountTokenUsageParamsThreadID *string
...
// InAppBrowserRequirements represents a generated Codex app-server protocol type.
type InAppBrowserRequirements struct {
	// AllowExternalBrowserSettingsImport corresponds to the JSON schema field
	// "allowExternalBrowserSettingsImport".
	AllowExternalBrowserSettingsImport InAppBrowserRequirementsAllowExternalBrowserSettingsImport `json:"allowExternalBrowserSettingsImport,omitempty,omitzero"`
}

// InAppBrowserRequirementsAllowExternalBrowserSettingsImport represents a generated Codex app-server protocol type.
type InAppBrowserRequirementsAllowExternalBrowserSettingsImport *bool
...
// InitializeCapabilitiesExtensions represents a generated Codex app-server protocol type.
// MCP extension settings declared by the app-server client.
...
// InstalledApp represents a generated Codex app-server protocol type.
...
// InstalledAppRuntimeName represents a generated Codex app-server protocol type.
// Best-effort name carried by the runtime tool catalog. Canonical app metadata
// remains owned by `app/read`.
...
type MCPResourceReadParams struct {
	...
	ConnectorID MCPResourceReadParamsConnectorID `json:"connectorId,omitempty,omitzero"`

	// Originating MCP tool call used to select the resource's app.
	OriginCallID MCPResourceReadParamsOriginCallID `json:"originCallId,omitempty,omitzero"`
...
// MCPResourceReadParamsConnectorID represents a generated Codex app-server protocol type.
type MCPResourceReadParamsConnectorID *string

// MCPResourceReadParamsOriginCallID represents a generated Codex app-server protocol type.
// Originating MCP tool call used to select the resource's app.
type MCPResourceReadParamsOriginCallID *string
...
// MCPServerConnectionStatus represents a generated Codex app-server protocol type.
type MCPServerConnectionStatus string

// MCPServerConnectionStatusAuthenticationRequired is a generated Codex app-server protocol constant.
const MCPServerConnectionStatusAuthenticationRequired MCPServerConnectionStatus = "authenticationRequired"

// MCPServerConnectionStatusCancelled is a generated Codex app-server protocol constant.
const MCPServerConnectionStatusCancelled MCPServerConnectionStatus = "cancelled"

// MCPServerConnectionStatusConnected is a generated Codex app-server protocol constant.
const MCPServerConnectionStatusConnected MCPServerConnectionStatus = "connected"

// MCPServerConnectionStatusDisabled is a generated Codex app-server protocol constant.
const MCPServerConnectionStatusDisabled MCPServerConnectionStatus = "disabled"

// MCPServerConnectionStatusFailed is a generated Codex app-server protocol constant.
const MCPServerConnectionStatusFailed MCPServerConnectionStatus = "failed"

// MCPServerConnectionStatusNotStarted is a generated Codex app-server protocol constant.
const MCPServerConnectionStatusNotStarted MCPServerConnectionStatus = "notStarted"

// MCPServerConnectionStatusStarting is a generated Codex app-server protocol constant.
const MCPServerConnectionStatusStarting MCPServerConnectionStatus = "starting"
...
// MCPServerEventNotification represents a generated Codex app-server protocol type.
...
// MCPServerOAuthClientRegistration represents a generated Codex app-server protocol type.
type MCPServerOAuthClientRegistration string

// MCPServerOAuthClientRegistrationAuto is a generated Codex app-server protocol constant.
const MCPServerOAuthClientRegistrationAuto MCPServerOAuthClientRegistration = "auto"

// MCPServerOAuthClientRegistrationCimd is a generated Codex app-server protocol constant.
const MCPServerOAuthClientRegistrationCimd MCPServerOAuthClientRegistration = "cimd"

// MCPServerOAuthClientRegistrationDcr is a generated Codex app-server protocol constant.
const MCPServerOAuthClientRegistrationDcr MCPServerOAuthClientRegistration = "dcr"

// MCPServerOAuthLoginParams represents a generated Codex app-server protocol type.
type MCPServerOAuthLoginParams struct {
	// Registration strategy for this login only; omission selects automatic
	// discovery.
	ClientRegistration *MCPServerOAuthClientRegistration `json:"clientRegistration,omitempty,omitzero"`
...
type MCPServerStatus struct {
	...
	PluginID MCPServerStatusPluginID `json:"pluginId,omitempty,omitzero"`
	...
	// Current thread-runtime connection state; null when unavailable or the
	// configuration changed.
	RuntimeStatus *MCPServerConnectionStatus `json:"runtimeStatus,omitempty,omitzero"`
	...
	// Tool discovery failed and no catalog was returned. Null when a catalog is
	// returned, including cached or empty catalogs.
	ToolsError MCPServerStatusToolsError `json:"toolsError,omitempty,omitzero"`
}
...
// MCPServerStatusPluginID represents a generated Codex app-server protocol type.
type MCPServerStatusPluginID *string

// MCPServerStatusTools represents a generated Codex app-server protocol type.
type MCPServerStatusTools map[string]Tool

// MCPServerStatusToolsError represents a generated Codex app-server protocol type.
// Tool discovery failed and no catalog was returned. Null when a catalog is
// returned, including cached or empty catalogs.
type MCPServerStatusToolsError *string
...
type ManagedHooksRequirements struct {
	// Interrupt corresponds to the JSON schema field "Interrupt".
	Interrupt []ConfiguredHookMatcherGroup `json:"Interrupt,omitempty,omitzero"`
...
// MisalignmentErrorDetails represents a generated Codex app-server protocol type.
type MisalignmentErrorDetails struct {
	// A substantive localized explanation is required before offering continuation.
	DetailedExplanation MisalignmentErrorDetailsDetailedExplanation `json:"detailedExplanation,omitempty,omitzero"`

	// Open-ended classification; clients must accept categories added by Responses.
	ErrorType MisalignmentErrorDetailsErrorType `json:"errorType,omitempty,omitzero"`

	// Instruction to submit as the next turn's user input if continuation is
	// confirmed.
	Steer *MisalignmentSteer `json:"steer,omitempty,omitzero"`
}

// MisalignmentErrorDetailsDetailedExplanation represents a generated Codex app-server protocol type.
// A substantive localized explanation is required before offering continuation.
type MisalignmentErrorDetailsDetailedExplanation *string

// MisalignmentErrorDetailsErrorType represents a generated Codex app-server protocol type.
// Open-ended classification; clients must accept categories added by Responses.
type MisalignmentErrorDetailsErrorType *string

// MisalignmentSteer represents a generated Codex app-server protocol type.
...
type Model struct {
	...
	MultiAgentVersion *MultiAgentVersion `json:"multiAgentVersion,omitempty,omitzero"`
...
type ModelUpgradeInfo struct {
	...
	RetirementAt ModelUpgradeInfoRetirementAt `json:"retirementAt,omitempty,omitzero"`
...
// ModelUpgradeInfoRetirementAt represents a generated Codex app-server protocol type.
// Informational Unix timestamp for this upgrade's scheduled retirement, if known.
type ModelUpgradeInfoRetirementAt *int
...
// MultiAgentVersion represents a generated Codex app-server protocol type.
type MultiAgentVersion string

// MultiAgentVersionDisabled is a generated Codex app-server protocol constant.
const MultiAgentVersionDisabled MultiAgentVersion = "disabled"

// MultiAgentVersionV1 is a generated Codex app-server protocol constant.
const MultiAgentVersionV1 MultiAgentVersion = "v1"

// MultiAgentVersionV2 is a generated Codex app-server protocol constant.
const MultiAgentVersionV2 MultiAgentVersion = "v2"
...
// PlanTypeEduPlus is a generated Codex app-server protocol constant.
const PlanTypeEduPlus PlanType = "edu_plus"

// PlanTypeEduPro is a generated Codex app-server protocol constant.
const PlanTypeEduPro PlanType = "edu_pro"
...
type PluginInstallParams struct {
	...
	InstallAttemptID PluginInstallParamsInstallAttemptID `json:"installAttemptId,omitempty,omitzero"`
...
// PluginInstallParamsInstallAttemptID represents a generated Codex app-server protocol type.
// Client-generated identifier used to correlate one installation attempt.
type PluginInstallParamsInstallAttemptID *string
...
// PluginReconcileChangedPlugin represents a generated Codex app-server protocol type.
// Runtime categories affected by this change, not just capabilities currently
// present. Flags describe declarations before runtime policy filtering. Updates OR
// the old and new bundle flags; enablement changes and cached reinstalls use the
// cached bundle; removals retain the old bundle's flags.
type PluginReconcileChangedPlugin struct {
	// HasApps corresponds to the JSON schema field "hasApps".
	HasApps bool `json:"hasApps"`

	// HasHooks corresponds to the JSON schema field "hasHooks".
	HasHooks bool `json:"hasHooks"`

	// HasMcps corresponds to the JSON schema field "hasMcps".
	HasMcps bool `json:"hasMcps"`

	// Whether either bundle declares skill roots; not a validated inventory of
	// enabled skills.
...
// PluginReconcileParams represents a generated Codex app-server protocol type.
type PluginReconcileParams struct {
	// Optional client-provided reason recorded with the reconciliation attempt.
	Reason PluginReconcileParamsReason `json:"reason,omitempty,omitzero"`
}

// PluginReconcileParamsReason represents a generated Codex app-server protocol type.
// Optional client-provided reason recorded with the reconciliation attempt.
type PluginReconcileParamsReason *string
...
// ProjectChangeType represents a generated Codex app-server protocol type.
type ProjectChangeType string

// ProjectChangeTypeCreated is a generated Codex app-server protocol constant.
const ProjectChangeTypeCreated ProjectChangeType = "created"

// ProjectChangeTypeDeleted is a generated Codex app-server protocol constant.
const ProjectChangeTypeDeleted ProjectChangeType = "deleted"

// ProjectChangeTypeUpdated is a generated Codex app-server protocol constant.
const ProjectChangeTypeUpdated ProjectChangeType = "updated"

// ProjectRoot represents a generated Codex app-server protocol type.
type ProjectRoot struct {
	// Path corresponds to the JSON schema field "path".
	Path AbsolutePathBuf `json:"path"`
}

// ProjectSortKey represents a generated Codex app-server protocol type.
type ProjectSortKey string

// ProjectSortKeyPosition is a generated Codex app-server protocol constant.
const ProjectSortKeyPosition ProjectSortKey = "position"

// ProjectSortKeyRecencyAt is a generated Codex app-server protocol constant.
const ProjectSortKeyRecencyAt ProjectSortKey = "recencyAt"
...
type RateLimitSnapshot struct {
	...
	// Normal model whose display name and reasoning options describe this quota
	// alias.
	NormalModelSlug RateLimitSnapshotNormalModelSlug `json:"normalModelSlug,omitempty,omitzero"`
...
// RateLimitSnapshotNormalModelSlug represents a generated Codex app-server protocol type.
// Normal model whose display name and reasoning options describe this quota alias.
type RateLimitSnapshotNormalModelSlug *string

// RateLimitSnapshotSpendControlReached represents a generated Codex app-server protocol type.
...
// RequestPermissionProfile represents a generated Codex app-server protocol type.
...
// ResponseUsageMetadata represents a generated Codex app-server protocol type.
...
type ResponseUsageMetadata struct {
	...
	Amount ResponseUsageMetadataAmount `json:"amount,omitempty,omitzero"`

	// Metadata corresponds to the JSON schema field "metadata".
	Metadata interface{} `json:"metadata,omitempty,omitzero"`
}

// ResponseUsageMetadataAmount represents a generated Codex app-server protocol type.
type ResponseUsageMetadataAmount *string
...
type ReviewStartParams struct {
	...
	// a new thread (returned in `reviewThreadId`). Detached delivery is deprecated
	// and emits `deprecationNotice`. Use `thread/start` followed by an inline review
	// for a separate review thread.
...
// SanitizedAppsInstalledParamsJSON represents a generated Codex app-server protocol type.
// Read the committed installed connector runtime snapshot.
...
// SanitizedAppsInstalledParamsJSONThreadID represents a generated Codex app-server protocol type.
// Optional loaded thread id used to evaluate effective app configuration.
type SanitizedAppsInstalledParamsJSONThreadID *string

// SanitizedAppsInstalledResponseJSON represents a generated Codex app-server protocol type.
// The installed connectors in one committed runtime snapshot.
// Deprecated: use AppsInstalledResponse.
...
// SanitizedAppsReadParamsJSON represents a generated Codex app-server protocol type.
// EXPERIMENTAL - read metadata for specific apps/connectors.
type SanitizedAppsReadParamsJSON struct {
	...
	// Optional loaded thread id used to evaluate effective app configuration.
	ThreadID SanitizedAppsReadParamsJSONThreadID `json:"threadId,omitempty,omitzero"`
}

// SanitizedAppsReadParamsJSONThreadID represents a generated Codex app-server protocol type.
// Optional loaded thread id used to evaluate effective app configuration.
type SanitizedAppsReadParamsJSONThreadID *string

// SanitizedAppsReadResponseJSON represents a generated Codex app-server protocol type.
// EXPERIMENTAL - app/read response.
// Deprecated: use AppsReadResponse.
...
// SanitizedAuthRecoveryNotificationJSON represents a generated Codex app-server protocol type.
// Deprecated: use AuthRecoveryNotification.
type SanitizedAuthRecoveryNotificationJSON struct {
	// Message corresponds to the JSON schema field "message".
	Message string `json:"message"`
...
type SanitizedCommandExecutionRequestApprovalParamsJSON struct {
	...
	// to disambiguate routing. Stdin approvals also use a distinct callback id;
	// inspect `kind` to distinguish them.
	...
	Kind interface{} `json:"kind,omitempty,omitzero"`
...
// SanitizedCommandExecutionRequestApprovalParamsJSONApprovalID represents a generated Codex app-server protocol type.
// Unique identifier for this specific approval callback.
//
// For regular shell/unified_exec approvals, this is null.
//
...
// SanitizedCommandExecutionRequestApprovalParamsJSONCommand represents a generated Codex app-server protocol type.
// The command to be executed.
type SanitizedCommandExecutionRequestApprovalParamsJSONCommand *string

// SanitizedCommandExecutionRequestApprovalParamsJSONCommandActions represents a generated Codex app-server protocol type.
// Best-effort parsed command actions for friendly display.
type SanitizedCommandExecutionRequestApprovalParamsJSONCommandActions []CommandAction

// SanitizedCommandExecutionRequestApprovalParamsJSONEnvironmentID represents a generated Codex app-server protocol type.
// Environment in which the command will run.
type SanitizedCommandExecutionRequestApprovalParamsJSONEnvironmentID *string

// SanitizedCommandExecutionRequestApprovalParamsJSONProposedExecpolicyAmendment represents a generated Codex app-server protocol type.
// Optional proposed execpolicy amendment to allow similar commands without
// prompting.
type SanitizedCommandExecutionRequestApprovalParamsJSONProposedExecpolicyAmendment []string

// SanitizedCommandExecutionRequestApprovalParamsJSONProposedNetworkPolicyAmendments represents a generated Codex app-server protocol type.
// Optional proposed network policy amendments (allow/deny host) for future
// requests.
type SanitizedCommandExecutionRequestApprovalParamsJSONProposedNetworkPolicyAmendments []NetworkPolicyAmendment

// SanitizedCommandExecutionRequestApprovalParamsJSONReason represents a generated Codex app-server protocol type.
// Optional explanatory reason (e.g. request for network access).
...
// SanitizedEnvironmentConnectionNotificationJSON represents a generated Codex app-server protocol type.
// Deprecated: use EnvironmentConnectionNotification.
...
// SanitizedExternalAgentConfigDetectParamsJSONMaxSessionAgeDays represents a generated Codex app-server protocol type.
// Maximum age in days for detected sessions. Missing values use the default limit.
type SanitizedExternalAgentConfigDetectParamsJSONMaxSessionAgeDays *int

// SanitizedExternalAgentConfigDetectParamsJSONMaxSessions represents a generated Codex app-server protocol type.
// Maximum number of sessions to detect. Missing values use the default limit.
type SanitizedExternalAgentConfigDetectParamsJSONMaxSessions *int

// SanitizedExternalAgentConfigDetectParamsJSONMigrationSource represents a generated Codex app-server protocol type.
// Optional migration-source selector. Missing or unrecognized values use the
// default source.
type SanitizedExternalAgentConfigDetectParamsJSONMigrationSource *string

// SanitizedExternalAgentConfigDetectParamsJSONSource represents a generated Codex app-server protocol type.
// Deprecated field retained for compatibility. This field is ignored; use
// `migrationSource` to select the migration source.
...
// SanitizedExternalAgentConfigImportHistoryRecordResponseJSON represents a generated Codex app-server protocol type.
// Deprecated: use ExternalAgentConfigImportHistoryRecordResponse.
...
// SanitizedExternalAgentConfigImportParamsJSONMigrationSource represents a generated Codex app-server protocol type.
// Migration-source selector used to produce the migration items. Pass the same
// value to detection and import; missing or unrecognized values use the default
// source.
type SanitizedExternalAgentConfigImportParamsJSONMigrationSource *string

// SanitizedExternalAgentConfigImportParamsJSONProviderID represents a generated Codex app-server protocol type.
// Opaque provider identifier supplied by the caller for analytics attribution and
// import history display. This does not select the migration source.
...
type SanitizedGetAccountRateLimitsResponseJSON struct {
	...
	AccountID SanitizedGetAccountRateLimitsResponseJSONAccountID `json:"accountId,omitempty,omitzero"`

	// Backend permission for ordinary included usage, validated against the active
	// account. Null means unavailable; clients must not infer recovery from
	// percentages or reset times.
	OrdinaryUsageAllowed SanitizedGetAccountRateLimitsResponseJSONOrdinaryUsageAllowed `json:"ordinaryUsageAllowed,omitempty,omitzero"`
	...
	// Optional backend-owned banner from the same usage read. Its nested keys retain
	// the backend's snake_case contract; an absent banner leaves the client's
	// existing UI unchanged.
	RateLimitUpsell interface{} `json:"rateLimitUpsell,omitempty,omitzero"`
...
// SanitizedGetAccountRateLimitsResponseJSONAccountID represents a generated Codex app-server protocol type.
// Account associated with this usage snapshot, when supplied by the backend.
type SanitizedGetAccountRateLimitsResponseJSONAccountID *string

// SanitizedGetAccountRateLimitsResponseJSONOrdinaryUsageAllowed represents a generated Codex app-server protocol type.
// Backend permission for ordinary included usage, validated against the active
// account. Null means unavailable; clients must not infer recovery from
// percentages or reset times.
type SanitizedGetAccountRateLimitsResponseJSONOrdinaryUsageAllowed *bool
...
type SanitizedGetAccountTokenUsageResponseJSON struct {
	...
	ThreadUsage *ThreadUsage `json:"threadUsage,omitempty,omitzero"`
}
...
type SanitizedMCPResourceReadParamsJSON struct {
	// ConnectorID corresponds to the JSON schema field "connectorId".
	ConnectorID SanitizedMCPResourceReadParamsJSONConnectorID `json:"connectorId,omitempty,omitzero"`

	// Originating MCP tool call used to select the resource's app.
	OriginCallID SanitizedMCPResourceReadParamsJSONOriginCallID `json:"originCallId,omitempty,omitzero"`
...
// SanitizedMCPResourceReadParamsJSONConnectorID represents a generated Codex app-server protocol type.
type SanitizedMCPResourceReadParamsJSONConnectorID *string

// SanitizedMCPResourceReadParamsJSONOriginCallID represents a generated Codex app-server protocol type.
// Originating MCP tool call used to select the resource's app.
type SanitizedMCPResourceReadParamsJSONOriginCallID *string
...
type SanitizedMCPResourceReadResponseJSON struct {
	...
	OriginCallID SanitizedMCPResourceReadResponseJSONOriginCallID `json:"originCallId,omitempty,omitzero"`
}

// SanitizedMCPResourceReadResponseJSONOriginCallID represents a generated Codex app-server protocol type.
// Originating call when the server applied app-specific resource scoping.
type SanitizedMCPResourceReadResponseJSONOriginCallID *string
...
// SanitizedMCPServerEventStreamNotificationJSON represents a generated Codex app-server protocol type.
// Deprecated: use MCPServerEventStreamNotification.
type SanitizedMCPServerEventStreamNotificationJSON struct {
	// Notification corresponds to the JSON schema field "notification".
...
// SanitizedPermissionsRequestApprovalParamsJSON represents a generated Codex app-server protocol type.
type SanitizedPermissionsRequestApprovalParamsJSON struct {
	// Cwd corresponds to the JSON schema field "cwd".
	Cwd LegacyAppPathString `json:"cwd"`

	// EnvironmentID corresponds to the JSON schema field "environmentId".
	EnvironmentID SanitizedPermissionsRequestApprovalParamsJSONEnvironmentID `json:"environmentId,omitempty,omitzero"`
	...
	// Reason corresponds to the JSON schema field "reason".
	Reason SanitizedPermissionsRequestApprovalParamsJSONReason `json:"reason,omitempty,omitzero"`
...
// SanitizedPermissionsRequestApprovalParamsJSONEnvironmentID represents a generated Codex app-server protocol type.
type SanitizedPermissionsRequestApprovalParamsJSONEnvironmentID *string

// SanitizedPermissionsRequestApprovalParamsJSONReason represents a generated Codex app-server protocol type.
type SanitizedPermissionsRequestApprovalParamsJSONReason *string
...
// SanitizedPluginReconcileParamsJSON represents a generated Codex app-server protocol type.
type SanitizedPluginReconcileParamsJSON struct {
	// Optional client-provided reason recorded with the reconciliation attempt.
	Reason SanitizedPluginReconcileParamsJSONReason `json:"reason,omitempty,omitzero"`
}

// SanitizedPluginReconcileParamsJSONReason represents a generated Codex app-server protocol type.
// Optional client-provided reason recorded with the reconciliation attempt.
type SanitizedPluginReconcileParamsJSONReason *string

// SanitizedPluginReconcileResponseJSON represents a generated Codex app-server protocol type.
// Bundle and installed-state changes observed by this pass, not a
// runtime-readiness acknowledgement or a cumulative diff since the client's last
// request. Other metadata-only changes are not listed.
// Deprecated: use PluginReconcileResponse.
type SanitizedPluginReconcileResponseJSON struct {
	...
	// cached reinstalls. Removal hints survive cache cleanup failures; unchanged
	// plugins are omitted.
	ChangedPlugins []PluginReconcileChangedPlugin `json:"changedPlugins"`

	// Subset of failures for which the requested bundle could not be materialized. A
	// previously cached version may still be available.
...
// SanitizedProjectChangedNotificationJSON represents a generated Codex app-server protocol type.
// Deprecated: use ProjectChangedNotification.
type SanitizedProjectChangedNotificationJSON struct {
	// ChangeType corresponds to the JSON schema field "changeType".
...
// SanitizedRawResponseCompletedNotificationJSON represents a generated Codex app-server protocol type.
// Internal-only notification containing the exact usage from one upstream
// Responses API completion.
// Deprecated: use RawResponseCompletedNotification.
type SanitizedRawResponseCompletedNotificationJSON struct {
	...
	// UsageMetadata corresponds to the JSON schema field "usageMetadata".
	UsageMetadata *ResponseUsageMetadata `json:"usageMetadata,omitempty,omitzero"`
}
...
// SanitizedStrictReviewRequiredNotificationJSON represents a generated Codex app-server protocol type.
// Deprecated: use StrictReviewRequiredNotification.
type SanitizedStrictReviewRequiredNotificationJSON struct {
...
// SanitizedThreadItemsListParamsJSON represents a generated Codex app-server protocol type.
type SanitizedThreadItemsListParamsJSON struct {
	// Opaque cursor to pass to the next call to continue after the last item.
	Cursor SanitizedThreadItemsListParamsJSONCursor `json:"cursor,omitempty,omitzero"`

	// Optional item page size.
	Limit SanitizedThreadItemsListParamsJSONLimit `json:"limit,omitempty,omitzero"`
	...
	TurnID SanitizedThreadItemsListParamsJSONTurnID `json:"turnId,omitempty,omitzero"`
}

// SanitizedThreadItemsListParamsJSONCursor represents a generated Codex app-server protocol type.
// Opaque cursor to pass to the next call to continue after the last item.
type SanitizedThreadItemsListParamsJSONCursor *string

// SanitizedThreadItemsListParamsJSONLimit represents a generated Codex app-server protocol type.
// Optional item page size.
type SanitizedThreadItemsListParamsJSONLimit *int

// SanitizedThreadItemsListParamsJSONTurnID represents a generated Codex app-server protocol type.
// Optional turn id to filter by. When omitted, returns items across the thread.
type SanitizedThreadItemsListParamsJSONTurnID *string
...
type SanitizedThreadListParamsJSON struct {
	...
	// Optional originator allowlist, matching any supplied value exactly. Supported
	// by hosted backends only; the local app-server rejects a nonempty list. Omitted
	// or empty lists leave originators unrestricted.
	Originators *SanitizedThreadListParamsJSONOriginators `json:"originators,omitempty,omitzero"`
...
// SanitizedThreadListParamsJSONOriginators represents a generated Codex app-server protocol type.
// Optional originator allowlist, matching any supplied value exactly. Supported by
// hosted backends only; the local app-server rejects a nonempty list. Omitted or
// empty lists leave originators unrestricted.
type SanitizedThreadListParamsJSONOriginators []string
...
// SanitizedThreadListParamsJSONSectionID represents a generated Codex app-server protocol type.
// Omit to include every section, set to `null` for unsectioned threads, or provide
// a section ID to return only threads in that section.
...
// SanitizedThreadMetadataUpdateParamsJSONIsPinned represents a generated Codex app-server protocol type.
// Deprecated: Codex 0.147 removed this field in favor of thread sections; retained
// for Go SDK source compatibility.
...
// SanitizedThreadProjectUpdatedNotificationJSON represents a generated Codex app-server protocol type.
// Deprecated: use ThreadProjectUpdatedNotification.
type SanitizedThreadProjectUpdatedNotificationJSON struct {
	// ProjectID corresponds to the JSON schema field "projectId".
	ProjectID SanitizedThreadProjectUpdatedNotificationJSONProjectID `json:"projectId"`

	// ThreadID corresponds to the JSON schema field "threadId".
	ThreadID string `json:"threadId"`
}

// SanitizedThreadProjectUpdatedNotificationJSONProjectID represents a generated Codex app-server protocol type.
type SanitizedThreadProjectUpdatedNotificationJSONProjectID *string

// SanitizedThreadQueueChangedNotificationJSON represents a generated Codex app-server protocol type.
// Deprecated: use ThreadQueueChangedNotification.
type SanitizedThreadQueueChangedNotificationJSON struct {
	// ThreadID corresponds to the JSON schema field "threadId".
	ThreadID string `json:"threadId"`
}
...
type SanitizedThreadReadParamsJSON struct {
	// When true, include turns and their items from rollout history. Full-history
	// hydration is deprecated for paginated threads; prefer a metadata-only read and
	// page with `thread/turns/list` and `thread/items/list`.
...
// SanitizedThreadRealtimeItemCompletedNotificationJSON represents a generated Codex app-server protocol type.
// EXPERIMENTAL - a realtime timeline item published after canonical commit.
// Deprecated: use ThreadRealtimeItemCompletedNotification.
type SanitizedThreadRealtimeItemCompletedNotificationJSON struct {
	// Item corresponds to the JSON schema field "item".
...
// SanitizedThreadRealtimeItemStartedNotificationJSON represents a generated Codex app-server protocol type.
// EXPERIMENTAL - a realtime timeline item started before its content streams.
// Deprecated: use ThreadRealtimeItemStartedNotification.
type SanitizedThreadRealtimeItemStartedNotificationJSON struct {
	// Item corresponds to the JSON schema field "item".
	Item ThreadRealtimeItem `json:"item"`
...
// SanitizedThreadRealtimeItemTranscriptDeltaNotificationJSON represents a generated Codex app-server protocol type.
// EXPERIMENTAL - text appended to an active realtime transcript item.
// Deprecated: use ThreadRealtimeItemTranscriptDeltaNotification.
type SanitizedThreadRealtimeItemTranscriptDeltaNotificationJSON struct {
	// Delta corresponds to the JSON schema field "delta".
	Delta string `json:"delta"`
...
// SanitizedThreadRevertParamsJSON represents a generated Codex app-server protocol type.
// Replace a paginated thread's durable history with the prefix before one turn.
//
// This only changes persisted conversation history. It does not revert local file
// changes.
type SanitizedThreadRevertParamsJSON struct {
...
// SanitizedThreadRevertedNotificationJSON represents a generated Codex app-server protocol type.
// Deprecated: use ThreadRevertedNotification.
type SanitizedThreadRevertedNotificationJSON struct {
	// ThreadID corresponds to the JSON schema field "threadId".
	ThreadID string `json:"threadId"`
}
...
// SanitizedThreadSectionCreateParamsJSON represents a generated Codex app-server protocol type.
...
type SanitizedThreadSectionCreateParamsJSON struct {
	...
	Appearance *ThreadSectionAppearance `json:"appearance,omitempty,omitzero"`

	// The user-visible name of the section.
	Name string `json:"name"`
}

// SanitizedThreadSectionDeleteParamsJSON represents a generated Codex app-server protocol type.
...
// SanitizedThreadSectionDeleteResponseJSON represents a generated Codex app-server protocol type.
// Successful deletion does not return additional section data.
// Deprecated: use ThreadSectionDeleteResponse.
type SanitizedThreadSectionDeleteResponseJSON map[string]interface{}

// SanitizedThreadSectionListParamsJSON represents a generated Codex app-server protocol type.
...
// SanitizedThreadSectionListParamsJSONCursor represents a generated Codex app-server protocol type.
// Opaque pagination cursor returned by a previous call.
type SanitizedThreadSectionListParamsJSONCursor *string

// SanitizedThreadSectionListParamsJSONLimit represents a generated Codex app-server protocol type.
// Maximum number of sections to return.
type SanitizedThreadSectionListParamsJSONLimit *int

// SanitizedThreadSectionMoveParamsJSON represents a generated Codex app-server protocol type.
...
// SanitizedThreadSectionMoveParamsJSONBeforeThreadID represents a generated Codex app-server protocol type.
// Existing thread to insert before; omission or null appends to the section.
type SanitizedThreadSectionMoveParamsJSONBeforeThreadID *string

// SanitizedThreadSectionMoveParamsJSONSectionID represents a generated Codex app-server protocol type.
// Destination section, or `null` to remove the thread from its section.
type SanitizedThreadSectionMoveParamsJSONSectionID *string

// SanitizedThreadSectionMoveResponseJSON represents a generated Codex app-server protocol type.
// Deprecated: use ThreadSectionMoveResponse.
...
type SanitizedThreadShellCommandParamsJSON struct {
	...
	// Maximum execution time in milliseconds. Defaults to one hour when omitted or
	// null. Must be non-negative; zero requests an immediate timeout, not unlimited
	// execution. Does not affect the immediate RPC acknowledgement.
	TimeoutMs SanitizedThreadShellCommandParamsJSONTimeoutMs `json:"timeoutMs,omitempty,omitzero"`
}

// SanitizedThreadShellCommandParamsJSONTimeoutMs represents a generated Codex app-server protocol type.
// Maximum execution time in milliseconds. Defaults to one hour when omitted or
// null. Must be non-negative; zero requests an immediate timeout, not unlimited
// execution. Does not affect the immediate RPC acknowledgement.
type SanitizedThreadShellCommandParamsJSONTimeoutMs *int
...
// SanitizedThreadTurnsListParamsJSON represents a generated Codex app-server protocol type.
type SanitizedThreadTurnsListParamsJSON struct {
	// Opaque cursor to pass to the next call to continue after the last turn.
	Cursor SanitizedThreadTurnsListParamsJSONCursor `json:"cursor,omitempty,omitzero"`

	// How much item detail to include for each returned turn; defaults to summary.
	ItemsView TurnItemsView `json:"itemsView,omitempty,omitzero"`

	// Optional turn page size.
	Limit SanitizedThreadTurnsListParamsJSONLimit `json:"limit,omitempty,omitzero"`
...
// SanitizedThreadTurnsListParamsJSONCursor represents a generated Codex app-server protocol type.
// Opaque cursor to pass to the next call to continue after the last turn.
type SanitizedThreadTurnsListParamsJSONCursor *string

// SanitizedThreadTurnsListParamsJSONLimit represents a generated Codex app-server protocol type.
// Optional turn page size.
type SanitizedThreadTurnsListParamsJSONLimit *int
...
// ThreadItemsListParams represents a generated Codex app-server protocol type.
type ThreadItemsListParams struct {
	// Opaque cursor to pass to the next call to continue after the last item.
	Cursor ThreadItemsListParamsCursor `json:"cursor,omitempty,omitzero"`

	// Optional item page size.
	Limit ThreadItemsListParamsLimit `json:"limit,omitempty,omitzero"`
	...
	// Optional turn id to filter by. When omitted, returns items across the thread.
	TurnID ThreadItemsListParamsTurnID `json:"turnId,omitempty,omitzero"`
}

// ThreadItemsListParamsCursor represents a generated Codex app-server protocol type.
// Opaque cursor to pass to the next call to continue after the last item.
type ThreadItemsListParamsCursor *string

// ThreadItemsListParamsLimit represents a generated Codex app-server protocol type.
// Optional item page size.
type ThreadItemsListParamsLimit *int

// ThreadItemsListParamsTurnID represents a generated Codex app-server protocol type.
// Optional turn id to filter by. When omitted, returns items across the thread.
type ThreadItemsListParamsTurnID *string
...
// ThreadListParamsOriginators represents a generated Codex app-server protocol type.
// Optional originator allowlist, matching any supplied value exactly. Supported by
// hosted backends only; the local app-server rejects a nonempty list. Omitted or
// empty lists leave originators unrestricted.
type ThreadListParamsOriginators []string

// ThreadListParamsSearchTerm represents a generated Codex app-server protocol type.
// Optional substring filter for the extracted thread title.
type ThreadListParamsSearchTerm *string

// ThreadListParamsSectionID represents a generated Codex app-server protocol type.
// Omit to include every section, set to `null` for unsectioned threads, or provide
// a section ID to return only threads in that section.
...
// ThreadMetadataUpdateParamsIsPinned represents a generated Codex app-server protocol type.
// Deprecated: Codex 0.147 removed this field in favor of thread sections; retained
// for Go SDK source compatibility.
...
// ThreadRealtimeInitialItem represents a generated Codex app-server protocol type.
// EXPERIMENTAL - role-bearing text item included when a realtime V3 session
// starts.
...
// ThreadRealtimeSessionOutcome represents a generated Codex app-server protocol type.
type ThreadRealtimeSessionOutcome string

// ThreadRealtimeSessionOutcomeEnded is a generated Codex app-server protocol constant.
const ThreadRealtimeSessionOutcomeEnded ThreadRealtimeSessionOutcome = "ended"

// ThreadRealtimeSessionOutcomeFailed is a generated Codex app-server protocol constant.
const ThreadRealtimeSessionOutcomeFailed ThreadRealtimeSessionOutcome = "failed"

// EXPERIMENTAL - transport used by thread realtime.

// ThreadRealtimeTranscriptRole represents a generated Codex app-server protocol type.
type ThreadRealtimeTranscriptRole string

// ThreadRealtimeTranscriptRoleAssistant is a generated Codex app-server protocol constant.
const ThreadRealtimeTranscriptRoleAssistant ThreadRealtimeTranscriptRole = "assistant"

// ThreadRealtimeTranscriptRoleUser is a generated Codex app-server protocol constant.
const ThreadRealtimeTranscriptRoleUser ThreadRealtimeTranscriptRole = "user"
...
// ThreadRevertParams represents a generated Codex app-server protocol type.
// Replace a paginated thread's durable history with the prefix before one turn.
//
// This only changes persisted conversation history. It does not revert local file
// changes.
...
// ThreadSectionAppearance represents a generated Codex app-server protocol type.
...
type ThreadSectionAppearance struct {
	...
	Color ThreadSectionAppearanceColor `json:"color,omitempty,omitzero"`

	// Icon corresponds to the JSON schema field "icon".
	Icon ThreadSectionAppearanceIcon `json:"icon,omitempty,omitzero"`
}

// ThreadSectionAppearanceColor represents a generated Codex app-server protocol type.
type ThreadSectionAppearanceColor *string

// ThreadSectionAppearanceIcon represents a generated Codex app-server protocol type.
type ThreadSectionAppearanceIcon *string

// ThreadSectionCreateParams represents a generated Codex app-server protocol type.
// Parameters for creating an independently persisted thread section.
...
// ThreadSectionDeleteParams represents a generated Codex app-server protocol type.
// Parameters for deleting an independently persisted thread section.
...
// ThreadSectionListParams represents a generated Codex app-server protocol type.
// Parameters for listing independently persisted thread sections.
...
// ThreadSectionListParamsCursor represents a generated Codex app-server protocol type.
// Opaque pagination cursor returned by a previous call.
type ThreadSectionListParamsCursor *string

// ThreadSectionListParamsLimit represents a generated Codex app-server protocol type.
// Maximum number of sections to return.
type ThreadSectionListParamsLimit *int

// ThreadSectionMoveParams represents a generated Codex app-server protocol type.
// Parameters for moving a thread within a server-owned section ordering.
...
// ThreadSectionMoveParamsBeforeThreadID represents a generated Codex app-server protocol type.
// Existing thread to insert before; omission or null appends to the section.
type ThreadSectionMoveParamsBeforeThreadID *string

// ThreadSectionMoveParamsSectionID represents a generated Codex app-server protocol type.
// Destination section, or `null` to remove the thread from its section.
...
type ThreadShellCommandParams struct {
	...
	// null. Must be non-negative; zero requests an immediate timeout, not unlimited
	// execution. Does not affect the immediate RPC acknowledgement.
	TimeoutMs ThreadShellCommandParamsTimeoutMs `json:"timeoutMs,omitempty,omitzero"`
}

// ThreadShellCommandParamsTimeoutMs represents a generated Codex app-server protocol type.
// Maximum execution time in milliseconds. Defaults to one hour when omitted or
// null. Must be non-negative; zero requests an immediate timeout, not unlimited
// execution. Does not affect the immediate RPC acknowledgement.
type ThreadShellCommandParamsTimeoutMs *int
...
// ThreadTurnsListParams represents a generated Codex app-server protocol type.
type ThreadTurnsListParams struct {
	// Opaque cursor to pass to the next call to continue after the last turn.
	Cursor ThreadTurnsListParamsCursor `json:"cursor,omitempty,omitzero"`

	// How much item detail to include for each returned turn; defaults to summary.
	ItemsView TurnItemsView `json:"itemsView,omitempty,omitzero"`

	// Optional turn page size.
	Limit ThreadTurnsListParamsLimit `json:"limit,omitempty,omitzero"`
...
// ThreadTurnsListParamsCursor represents a generated Codex app-server protocol type.
// Opaque cursor to pass to the next call to continue after the last turn.
type ThreadTurnsListParamsCursor *string

// ThreadTurnsListParamsLimit represents a generated Codex app-server protocol type.
// Optional turn page size.
type ThreadTurnsListParamsLimit *int
...
// ThreadUsage represents a generated Codex app-server protocol type.
type ThreadUsage struct {
	// EstimatedUsageCreditsMicros corresponds to the JSON schema field
	// "estimatedUsageCreditsMicros".
	EstimatedUsageCreditsMicros int `json:"estimatedUsageCreditsMicros"`

	// EstimatedUsageUsdMicros corresponds to the JSON schema field
	// "estimatedUsageUsdMicros".
	EstimatedUsageUsdMicros ThreadUsageEstimatedUsageUsdMicros `json:"estimatedUsageUsdMicros,omitempty,omitzero"`
...
// ThreadUsageBreakdownGroup represents a generated Codex app-server protocol type.
type ThreadUsageBreakdownGroup struct {
	// CachedInputTokens corresponds to the JSON schema field "cachedInputTokens".
	CachedInputTokens ThreadUsageBreakdownGroupCachedInputTokens `json:"cachedInputTokens,omitempty,omitzero"`
	...
	InputTokens ThreadUsageBreakdownGroupInputTokens `json:"inputTokens,omitempty,omitzero"`

	// Model corresponds to the JSON schema field "model".
	Model ThreadUsageBreakdownGroupModel `json:"model,omitempty,omitzero"`

	// NetNewInputTokens corresponds to the JSON schema field "netNewInputTokens".
	NetNewInputTokens ThreadUsageBreakdownGroupNetNewInputTokens `json:"netNewInputTokens,omitempty,omitzero"`

	// OutputTokens corresponds to the JSON schema field "outputTokens".
	OutputTokens ThreadUsageBreakdownGroupOutputTokens `json:"outputTokens,omitempty,omitzero"`

	// ReasoningEffort corresponds to the JSON schema field "reasoningEffort".
	ReasoningEffort ThreadUsageBreakdownGroupReasoningEffort `json:"reasoningEffort,omitempty,omitzero"`

	// Speed corresponds to the JSON schema field "speed".
	Speed ThreadUsageBreakdownGroupSpeed `json:"speed,omitempty,omitzero"`

	// TotalTokens corresponds to the JSON schema field "totalTokens".
	TotalTokens ThreadUsageBreakdownGroupTotalTokens `json:"totalTokens,omitempty,omitzero"`
}

// ThreadUsageBreakdownGroupCachedInputTokens represents a generated Codex app-server protocol type.
type ThreadUsageBreakdownGroupCachedInputTokens *int

// ThreadUsageBreakdownGroupInputTokens represents a generated Codex app-server protocol type.
type ThreadUsageBreakdownGroupInputTokens *int

// ThreadUsageBreakdownGroupModel represents a generated Codex app-server protocol type.
type ThreadUsageBreakdownGroupModel *string

// ThreadUsageBreakdownGroupNetNewInputTokens represents a generated Codex app-server protocol type.
type ThreadUsageBreakdownGroupNetNewInputTokens *int

// ThreadUsageBreakdownGroupOutputTokens represents a generated Codex app-server protocol type.
type ThreadUsageBreakdownGroupOutputTokens *int

// ThreadUsageBreakdownGroupReasoningEffort represents a generated Codex app-server protocol type.
type ThreadUsageBreakdownGroupReasoningEffort *string

// ThreadUsageBreakdownGroupSpeed represents a generated Codex app-server protocol type.
type ThreadUsageBreakdownGroupSpeed *string

// ThreadUsageBreakdownGroupTotalTokens represents a generated Codex app-server protocol type.
type ThreadUsageBreakdownGroupTotalTokens *int

// ThreadUsageEstimatedUsageUsdMicros represents a generated Codex app-server protocol type.
type ThreadUsageEstimatedUsageUsdMicros *int
...
// TurnEnvironmentParamsRuntimeWorkspaceRoots represents a generated Codex app-server protocol type.
// Environment-native runtime workspace roots. Omitted defaults to `cwd`.
...
type TurnError struct {
	...
	// Optional public explanation and continuation instruction for a misalignment
	// block.
	Misalignment *MisalignmentErrorDetails `json:"misalignment,omitempty,omitzero"`
}
...
// TurnStartParamsServiceTierForTurn represents a generated Codex app-server protocol type.
// Override the service tier only when this request starts a new turn. Use
// "default" for standard speed. Omitted or null inherits the thread's tier. Does
// not change the thread's tier or a turn being steered.
type TurnStartParamsServiceTierForTurn *string

// TurnStartParamsTurnTrigger represents a generated Codex app-server protocol type.
// Optional source classification for the caller that starts this turn. Ignored
// when this request steers an already-active turn.
type TurnStartParamsTurnTrigger *string
...
// TurnToolOutput represents a generated Codex app-server protocol type.
type TurnToolOutput struct {
	// Name corresponds to the JSON schema field "name".
	Name string `json:"name"`

	// Namespace corresponds to the JSON schema field "namespace".
	Namespace TurnToolOutputNamespace `json:"namespace,omitempty,omitzero"`

	// Output corresponds to the JSON schema field "output".
	Output FunctionCallOutputBody `json:"output"`
}

// TurnToolOutputNamespace represents a generated Codex app-server protocol type.
type TurnToolOutputNamespace *string
