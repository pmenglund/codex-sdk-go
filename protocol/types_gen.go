...
type ThreadForkParams struct {
	...
	// Optional client-supplied analytics source classification for this forked
	// thread.
	ThreadSource interface{} `json:"threadSource,omitempty"`
}
...
const ThreadSourceMemoryConsolidation ThreadSource = "memory_consolidation"
const ThreadSourceSubagent ThreadSource = "subagent"
const ThreadSourceUser ThreadSource = "user"
