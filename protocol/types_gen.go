...
type SanitizedThreadListParamsJSON struct {
	...
	// Optional pinned filter; when set, only threads matching this value are
	// returned.
	IsPinned SanitizedThreadListParamsJSONIsPinned `json:"isPinned,omitempty,omitzero"`
...
// SanitizedThreadListParamsJSONIsPinned represents a generated Codex app-server protocol type.
// Optional pinned filter; when set, only threads matching this value are returned.
type SanitizedThreadListParamsJSONIsPinned *bool
...
type SanitizedThreadMetadataUpdateParamsJSON struct {
	...
	// stored value.
	GitInfo *ThreadMetadataGitInfoUpdateParams `json:"gitInfo,omitempty,omitzero"`

	// Patch whether this thread is pinned. Omit to leave the stored value unchanged.
	IsPinned SanitizedThreadMetadataUpdateParamsJSONIsPinned `json:"isPinned,omitempty,omitzero"`
...
// ThreadListParamsIsPinned represents a generated Codex app-server protocol type.
// Optional pinned filter; when set, only threads matching this value are returned.
type ThreadListParamsIsPinned *bool
...
type ThreadMetadataUpdateParams struct {
	...
	// Patch whether this thread is pinned. Omit to leave the stored value unchanged.
	IsPinned ThreadMetadataUpdateParamsIsPinned `json:"isPinned,omitempty,omitzero"`
