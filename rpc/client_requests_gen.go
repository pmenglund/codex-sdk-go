...
type ClientRequests interface {
	...
	DeviceKeyCreate(ctx context.Context, params protocol.DeviceKeyCreateParams) (*protocol.DeviceKeyCreateResponse, error)
	DeviceKeyPublic(ctx context.Context, params protocol.DeviceKeyPublicParams) (*protocol.DeviceKeyPublicResponse, error)
	DeviceKeySign(ctx context.Context, params protocol.DeviceKeySignParams) (*protocol.DeviceKeySignResponse, error)
...
func (c *Client) DeviceKeyCreate(ctx context.Context, params protocol.DeviceKeyCreateParams) (*protocol.DeviceKeyCreateResponse, error) {
	var result protocol.DeviceKeyCreateResponse
	if err := c.Call(ctx, "device/key/create", params, &result); err != nil {
		return nil, err
	}
	return &result, nil
}

func (c *Client) DeviceKeyPublic(ctx context.Context, params protocol.DeviceKeyPublicParams) (*protocol.DeviceKeyPublicResponse, error) {
	var result protocol.DeviceKeyPublicResponse
	if err := c.Call(ctx, "device/key/public", params, &result); err != nil {
		return nil, err
	}
	return &result, nil
}

func (c *Client) DeviceKeySign(ctx context.Context, params protocol.DeviceKeySignParams) (*protocol.DeviceKeySignResponse, error) {
	var result protocol.DeviceKeySignResponse
	if err := c.Call(ctx, "device/key/sign", params, &result); err != nil {
		return nil, err
	}
	return &result, nil
}
